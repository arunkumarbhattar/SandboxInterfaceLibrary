...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @get_or_allocate_wasm_fd(%struct.wasm_sandbox_wasi_data* %wasi_data, i32 %nfd) #0 {
entry:
  %retval = alloca i32, align 4
  %wasi_data.addr = alloca %struct.wasm_sandbox_wasi_data*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @get_native_fd(%struct.wasm_sandbox_wasi_data* %wasi_data, i32 %fd) #0 {
entry:
  %retval = alloca i32, align 4
  %wasi_data.addr = alloca %struct.wasm_sandbox_wasi_data*, align 8
  %fd.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @Z_envZ_signalZ_iii(%struct.wasm_sandbox_wasi_data* %wasi_data, i32 %a, i32 %b) #0 {
entry:
  %wasi_data.addr = alloca %struct.wasm_sandbox_wasi_data*, align 8
  %a.addr = alloca i32, align 4
  %b.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @Z_wasi_snapshot_preview1Z_path_remove_directoryZ_iiii(i32 %a, i32 %b, i32 %c) #0 {
entry:
  %a.addr = alloca i32, align 4
  %b.addr = alloca i32, align 4
  %c.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone tainted uwtable
define dso_local i32 @Z_wasi_snapshot_preview1Z_path_symlinkZ_iiiiii(i32 %a, i32 %b, i32 %c, i32 %d, i32 %e) #1 {
entry:
  %a.addr = alloca i32, align 4
  %b.addr = alloca i32, align 4
  %c.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @whence_to_native(i32 %whence) #0 {
entry:
  %retval = alloca i32, align 4
  %whence.addr = alloca i32, align 4
  store i32 %whence, i32* %whence.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @wasm_i32_load8_s(%struct.wasm_rt_memory_t* %mem, i64 %addr) #0 {
entry:
  %mem.addr = alloca %struct.wasm_rt_memory_t*, align 8
  %addr.addr = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i64 @wasm_i64_load32_s(%struct.wasm_rt_memory_t* %mem, i64 %addr) #0 {
entry:
  %mem.addr = alloca %struct.wasm_rt_memory_t*, align 8
  %addr.addr = alloca i64, align 8
  %result = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @wasm_f32_store(%struct.wasm_rt_memory_t* %mem, i64 %addr, float %value) #0 {
entry:
  %mem.addr = alloca %struct.wasm_rt_memory_t*, align 8
  %addr.addr = alloca i64, align 8
