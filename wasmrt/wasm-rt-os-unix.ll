...
; Function Attrs: noinline nounwind optnone tainted uwtable
define dso_local void @os_clock_cleanup(i8** %clock_data_pointer) #1 {
entry:
  %clock_data_pointer.addr = alloca i8**, align 8
  store i8** %clock_data_pointer, i8*** %clock_data_pointer.addr, align 8
  ret void
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @os_clock_gettime(i8* %clock_data, i32 %clock_id, %struct.timespec* %out_struct) #0 {
entry:
