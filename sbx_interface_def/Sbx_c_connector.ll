; ModuleID = 'Sbx_c_connector.cpp'
source_filename = "Sbx_c_connector.cpp"
...
%"struct.std::pair.38" = type { %"class.std::__cxx11::basic_string", i8* }
...
%"struct.std::pair.46" = type { i32, i8* }
...
%"struct.std::pair.51" = type <{ i8*, i32, [4 x i8] }>
...
%"class.rlbox::detail::scope_exit" = type <{ %class.anon, i8, [7 x i8] }>
%class.anon = type { %"class.rlbox::rlbox_wasm2c_sandbox"** }
%class.anon.54 = type { %"class.rlbox::rlbox_wasm2c_sandbox"*, i32** }
...
$_ZN12SbxInterfaceC2Ev = comdat any
...
$_ZN9__gnu_cxx13new_allocatorINSt8__detail10_Hash_nodeISt4pairIKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEmELb1EEEEC2Ev = comdat any
...
$_ZN9__gnu_cxx13new_allocatorINSt8__detail10_Hash_nodeISt4pairIKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEmELb1EEEED2Ev = comdat any
...
$_ZZN5rlbox20rlbox_wasm2c_sandbox19impl_create_sandboxEbmPKcE3sbb = comdat any

$_ZGVZN5rlbox20rlbox_wasm2c_sandbox19impl_create_sandboxEbmPKcE3sbb = comdat any
...
@_ZL21SbxInterface_Instance = internal global %class.SbxInterface* null, align 8
...
@.str = private unnamed_addr constant [81 x i8] c"create_sandbox called when sandbox already created/is being created concurrently\00", align 1
@.str.2 = private unnamed_addr constant [1 x i8] zeroinitializer, align 1
@_ZSt4cerr = external dso_local global %"class.std::basic_ostream", align 8
@.str.3 = private unnamed_addr constant [28 x i8] c"Sandbox already initialized\00", align 1
@.str.4 = private unnamed_addr constant [55 x i8] c"Static calls not supported with non empty module names\00", align 1
@.str.5 = private unnamed_addr constant [59 x i8] c"wasm2c could not find <MODULE_NAME>get_wasm2c_sandbox_info\00", align 1
@.str.6 = private unnamed_addr constant [35 x i8] c"Wasm allows a max heap size of 4GB\00", align 1
@.str.7 = private unnamed_addr constant [29 x i8] c"Sandbox could not be created\00", align 1
@.str.8 = private unnamed_addr constant [11 x i8] c"w2c_memory\00", align 1
@.str.9 = private unnamed_addr constant [41 x i8] c"Could not get wasm2c sandbox memory info\00", align 1
@.str.10 = private unnamed_addr constant [32 x i8] c"Sandbox heap not aligned to 4GB\00", align 1
@_ZZN5rlbox20rlbox_wasm2c_sandbox19impl_create_sandboxEbmPKcE3sbb = linkonce_odr dso_local global %struct.wasm2c_sandbox_t* null, comdat, align 8
@_ZGVZN5rlbox20rlbox_wasm2c_sandbox19impl_create_sandboxEbmPKcE3sbb = linkonce_odr dso_local global i64 0, comdat, align 8
...
@llvm.global_ctors = appending global [2 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @__cxx_global_var_init.1, i8* bitcast (%"class.std::vector"* @_ZN5rlbox13rlbox_sandboxINS_20rlbox_wasm2c_sandboxEE12sandbox_listE to i8*) }, { i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_Sbx_c_connector.cpp, i8* null }]
...
define dso_local void @sbx_init() #4 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
  %exn.slot = alloca i8*, align 8
  %ehselector.slot = alloca i32, align 4
  %0 = load %class.SbxInterface*, %class.SbxInterface** @_ZL21SbxInterface_Instance, align 8
  %cmp = icmp eq %class.SbxInterface* %0, null
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  %call = call noalias nonnull i8* @_Znwm(i64 3200) #20
  %1 = bitcast i8* %call to %class.SbxInterface*
  invoke void @_ZN12SbxInterfaceC2Ev(%class.SbxInterface* nonnull dereferenceable(3200) %1)
          to label %invoke.cont unwind label %lpad

invoke.cont:                                      ; preds = %if.then
  store %class.SbxInterface* %1, %class.SbxInterface** @_ZL21SbxInterface_Instance, align 8
  br label %if.end
...
define linkonce_odr dso_local void @_ZN12SbxInterfaceC2Ev(%class.SbxInterface* nonnull dereferenceable(3200) %this) unnamed_addr #6 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
  ...
  call void @_ZN5rlbox13rlbox_sandboxINS_20rlbox_wasm2c_sandboxEEC2Ev(%"class.rlbox::rlbox_sandbox"* nonnull dereferenceable(3144) %sandbox)
  %pointer_symbol_lookup = getelementptr inbounds %class.SbxInterface, %class.SbxInterface* %this1, i32 0, i32 1
  call void @_ZNSt13unordered_mapINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEmSt4hashIS5_ESt8equal_toIS5_ESaISt4pairIKS5_mEEEC2Ev(%"class.std::unordered_map"* nonnull dereferenceable(56) %pointer_symbol_lookup) #3
  %sandbox2 = getelementptr inbounds %class.SbxInterface, %class.SbxInterface* %this1, i32 0, i32 0
  %call = invoke zeroext i1 @_ZN5rlbox13rlbox_sandboxINS_20rlbox_wasm2c_sandboxEE14create_sandboxIJEEEbDpT_(%"class.rlbox::rlbox_sandbox"* nonnull dereferenceable(3144) %sandbox2)
          to label %invoke.cont unwind label %lpad
...
lpad:                                             ; preds = %entry
  ...
  call void @_ZNSt13unordered_mapINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEmSt4hashIS5_ESt8equal_toIS5_ESaISt4pairIKS5_mEEED2Ev(%"class.std::unordered_map"* nonnull dereferenceable(56) %pointer_symbol_lookup) #3
  call void @_ZN5rlbox13rlbox_sandboxINS_20rlbox_wasm2c_sandboxEED2Ev(%"class.rlbox::rlbox_sandbox"* nonnull dereferenceable(3144) %sandbox) #3
  br label %eh.resume
...
; Function Attrs: noinline optnone uwtable mustprogress
define dso_local zeroext i1 @c_isPointerToTaintedMem(i8* %pointer) #4 {
entry:
  ...
  %call = call zeroext i1 @_ZN12SbxInterface21isPointerToTaintedMemEPKv(%class.SbxInterface* nonnull dereferenceable(3200) %0, i8* %1)
  ret i1 %call
}

declare dso_local zeroext i1 @_ZN12SbxInterface21isPointerToTaintedMemEPKv(%class.SbxInterface* nonnull dereferenceable(3200), i8*) #1

; Function Attrs: noinline optnone uwtable mustprogress
define dso_local %struct.wasm2c_sandbox_t* @c_fetch_sandbox_address() #4 {
entry:
  call void @sbx_init()
  %0 = load %class.SbxInterface*, %class.SbxInterface** @_ZL21SbxInterface_Instance, align 8
  %call = call %struct.wasm2c_sandbox_t* @_ZN12SbxInterface21fetch_sandbox_addressEv(%class.SbxInterface* nonnull dereferenceable(3200) %0)
  ret %struct.wasm2c_sandbox_t* %call
}

declare dso_local %struct.wasm2c_sandbox_t* @_ZN12SbxInterface21fetch_sandbox_addressEv(%class.SbxInterface* nonnull dereferenceable(3200)) #1

; Function Attrs: noinline optnone uwtable mustprogress
define dso_local i32 @c_fetch_pointer_offset(i8* %pointer_name) #4 {
entry:
  ...
  %call = call i32 @_ZN12SbxInterface20fetch_pointer_offsetEPKc(%class.SbxInterface* nonnull dereferenceable(3200) %0, i8* %1)
  ret i32 %call
}

declare dso_local i32 @_ZN12SbxInterface20fetch_pointer_offsetEPKc(%class.SbxInterface* nonnull dereferenceable(3200), i8*) #1

; Function Attrs: noinline optnone uwtable mustprogress
define dso_local void @c_update_pointer_offset(i8* %pointer_name, i64 %offset) #4 {
entry:
  %pointer_name.addr = alloca i8*, align 8
  ...
  call void @_ZN12SbxInterface21update_pointer_offsetEPKcm(%class.SbxInterface* nonnull dereferenceable(3200) %0, i8* %1, i64 %2)
  ret void
}

declare dso_local void @_ZN12SbxInterface21update_pointer_offsetEPKcm(%class.SbxInterface* nonnull dereferenceable(3200), i8*, i64) #1

; Function Attrs: noinline optnone uwtable mustprogress
define dso_local i64 @c_fetch_sandbox_heap_address() #4 {
entry:
  call void @sbx_init()
  %0 = load %class.SbxInterface*, %class.SbxInterface** @_ZL21SbxInterface_Instance, align 8
  %call = call i64 @_ZN12SbxInterface26fetch_sandbox_heap_addressEv(%class.SbxInterface* nonnull dereferenceable(3200) %0)
  ret i64 %call
}

declare dso_local i64 @_ZN12SbxInterface26fetch_sandbox_heap_addressEv(%class.SbxInterface* nonnull dereferenceable(3200)) #1

; Function Attrs: noinline optnone uwtable mustprogress
define dso_local i8* @c_malloc(i8* %pointer_name, i64 %size) #4 {
entry:
  %pointer_name.addr = alloca i8*, align 8
  ...
  %call = call i8* @_ZN12SbxInterface10sbx_mallocEPKcm(%class.SbxInterface* nonnull dereferenceable(3200) %0, i8* %1, i64 %2)
  ret i8* %call
}

declare dso_local i8* @_ZN12SbxInterface10sbx_mallocEPKcm(%class.SbxInterface* nonnull dereferenceable(3200), i8*, i64) #1

; Function Attrs: noinline optnone uwtable mustprogress
define dso_local i8* @c_realloc(i8* %pointer_name, i64 %size) #4 {
entry:
  %pointer_name.addr = alloca i8*, align 8
  %size.addr = alloca i64, align 8
  store i8* %pointer_name, i8** %pointer_name.addr, align 8
  ...
  %1 = load i8*, i8** %pointer_name.addr, align 8
  %2 = load i64, i64* %size.addr, align 8
  %call = call i8* @_ZN12SbxInterface11sbx_reallocEPKcm(%class.SbxInterface* nonnull dereferenceable(3200) %0, i8* %1, i64 %2)
  ret i8* %call
}

declare dso_local i8* @_ZN12SbxInterface11sbx_reallocEPKcm(%class.SbxInterface* nonnull dereferenceable(3200), i8*, i64) #1

; Function Attrs: noinline optnone uwtable mustprogress
define dso_local void @c_free(i8* %pointer_name) #4 {
entry:
  %pointer_name.addr = alloca i8*, align 8
  store i8* %pointer_name, i8** %pointer_name.addr, align 8
  call void @sbx_init()
  %0 = load %class.SbxInterface*, %class.SbxInterface** @_ZL21SbxInterface_Instance, align 8
  %1 = load i8*, i8** %pointer_name.addr, align 8
  call void @_ZN12SbxInterface8sbx_freeEPKc(%class.SbxInterface* nonnull dereferenceable(3200) %0, i8* %1)
  ret void
}

declare dso_local void @_ZN12SbxInterface8sbx_freeEPKc(%class.SbxInterface* nonnull dereferenceable(3200), i8*) #1
...
define linkonce_odr dso_local void @_ZNSt6vectorIPvSaIS0_EEC2Ev(%"class.std::vector"* nonnull dereferenceable(24) %this) unnamed_addr #8 comdat align 2 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt6vectorIPvSaIS0_EED2Ev(%"class.std::vector"* nonnull dereferenceable(24) %this) unnamed_addr #8 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
  %this.addr = alloca %"class.std::vector"*, align 8
  %exn.slot = alloca i8*, align 8
  %ehselector.slot = alloca i32, align 4
...
terminate.handler:                                ; preds = %lpad
  %exn = load i8*, i8** %exn.slot, align 8
  call void @__clang_call_terminate(i8* %exn) #22
  unreachable
}

; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local void @_ZN5rlbox13rlbox_sandboxINS_20rlbox_wasm2c_sandboxEEC2Ev(%"class.rlbox::rlbox_sandbox"* nonnull dereferenceable(3144) %this) unnamed_addr #6 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
  ...
  call void @_ZN5rlbox20rlbox_wasm2c_sandboxC2Ev(%"class.rlbox::rlbox_wasm2c_sandbox"* nonnull dereferenceable(2840) %0) #3
...
lpad:                                             ; preds = %entry
  ...
  call void @_ZN5rlbox20rlbox_wasm2c_sandboxD2Ev(%"class.rlbox::rlbox_wasm2c_sandbox"* nonnull dereferenceable(2840) %4) #3
  br label %eh.resume
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt13unordered_mapINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEmSt4hashIS5_ESt8equal_toIS5_ESaISt4pairIKS5_mEEEC2Ev(%"class.std::unordered_map"* nonnull dereferenceable(56) %this) unnamed_addr #8 comdat align 2 {
entry:
...
; Function Attrs: noinline optnone uwtable mustprogress
define linkonce_odr dso_local zeroext i1 @_ZN5rlbox13rlbox_sandboxINS_20rlbox_wasm2c_sandboxEE14create_sandboxIJEEEbDpT_(%"class.rlbox::rlbox_sandbox"* nonnull dereferenceable(3144) %this) #4 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
  %this.addr = alloca %"class.rlbox::rlbox_sandbox"*, align 8
  ...
  call void @_ZN5rlbox6detail13dynamic_checkEbPKc(i1 zeroext %tobool, i8* getelementptr inbounds ([81 x i8], [81 x i8]* @.str, i64 0, i64 0))
  store i8 1, i8* %created, align 1
  %1 = bitcast %"class.rlbox::rlbox_sandbox"* %this1 to %"class.rlbox::rlbox_wasm2c_sandbox"*
  %call2 = call zeroext i1 @_ZN5rlbox20rlbox_wasm2c_sandbox19impl_create_sandboxEbmPKc(%"class.rlbox::rlbox_wasm2c_sandbox"* nonnull dereferenceable(2840) %1, i1 zeroext true, i64 0, i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.2, i64 0, i64 0))
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt13unordered_mapINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEmSt4hashIS5_ESt8equal_toIS5_ESaISt4pairIKS5_mEEED2Ev(%"class.std::unordered_map"* nonnull dereferenceable(56) %this) unnamed_addr #8 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::unordered_map"*, align 8
  store %"class.std::unordered_map"* %this, %"class.std::unordered_map"** %this.addr, align 8
  %this1 = load %"class.std::unordered_map"*, %"class.std::unordered_map"** %this.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZN5rlbox13rlbox_sandboxINS_20rlbox_wasm2c_sandboxEED2Ev(%"class.rlbox::rlbox_sandbox"* nonnull dereferenceable(3144) %this) unnamed_addr #8 comdat align 2 {
entry:
  %this.addr = alloca %"class.rlbox::rlbox_sandbox"*, align 8
  store %"class.rlbox::rlbox_sandbox"* %this, %"class.rlbox::rlbox_sandbox"** %this.addr, align 8
  %this1 = load %"class.rlbox::rlbox_sandbox"*, %"class.rlbox::rlbox_sandbox"** %this.addr, align 8
  ...
  call void @_ZNSt3mapINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEPvSt4lessIS5_ESaISt4pairIKS5_S6_EEED2Ev(%"class.std::map.8"* nonnull dereferenceable(48) %func_ptr_map) #3
  %0 = bitcast %"class.rlbox::rlbox_sandbox"* %this1 to %"class.rlbox::rlbox_wasm2c_sandbox"*
  call void @_ZN5rlbox20rlbox_wasm2c_sandboxD2Ev(%"class.rlbox::rlbox_wasm2c_sandbox"* nonnull dereferenceable(2840) %0) #3
  ret void
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZN5rlbox20rlbox_wasm2c_sandboxC2Ev(%"class.rlbox::rlbox_wasm2c_sandbox"* nonnull dereferenceable(2840) %this) unnamed_addr #8 comdat align 2 {
entry:
  ...
  %malloc_index = getelementptr inbounds %"class.rlbox::rlbox_wasm2c_sandbox", %"class.rlbox::rlbox_wasm2c_sandbox"* %this1, i32 0, i32 6
  store i8* null, i8** %malloc_index, align 8
  %free_index = getelementptr inbounds %"class.rlbox::rlbox_wasm2c_sandbox", %"class.rlbox::rlbox_wasm2c_sandbox"* %this1, i32 0, i32 7
  store i8* null, i8** %free_index, align 8
  %return_slot_size = getelementptr inbounds %"class.rlbox::rlbox_wasm2c_sandbox", %"class.rlbox::rlbox_wasm2c_sandbox"* %this1, i32 0, i32 8
  store i64 0, i64* %return_slot_size, align 8
  %return_slot = getelementptr inbounds %"class.rlbox::rlbox_wasm2c_sandbox", %"class.rlbox::rlbox_wasm2c_sandbox"* %this1, i32 0, i32 9
  store i32 0, i32* %return_slot, align 8
  %callback_mutex = getelementptr inbounds %"class.rlbox::rlbox_wasm2c_sandbox", %"class.rlbox::rlbox_wasm2c_sandbox"* %this1, i32 0, i32 10
  call void @_ZNSt18shared_timed_mutexC2Ev(%"class.std::shared_timed_mutex"* nonnull dereferenceable(56) %callback_mutex) #3
  %callback_unique_keys = getelementptr inbounds %"class.rlbox::rlbox_wasm2c_sandbox", %"class.rlbox::rlbox_wasm2c_sandbox"* %this1, i32 0, i32 11
...
arrayinit.end2:                                   ; preds = %arrayinit.body
  %callbacks = getelementptr inbounds %"class.rlbox::rlbox_wasm2c_sandbox", %"class.rlbox::rlbox_wasm2c_sandbox"* %this1, i32 0, i32 12
...
arrayinit.end10:                                  ; preds = %arrayinit.body6
  %callback_slot_assignment = getelementptr inbounds %"class.rlbox::rlbox_wasm2c_sandbox", %"class.rlbox::rlbox_wasm2c_sandbox"* %this1, i32 0, i32 13
...
arrayinit.end18:                                  ; preds = %arrayinit.body14
  %internal_callbacks = getelementptr inbounds %"class.rlbox::rlbox_wasm2c_sandbox", %"class.rlbox::rlbox_wasm2c_sandbox"* %this1, i32 0, i32 14
  ...
  %slot_assignments = getelementptr inbounds %"class.rlbox::rlbox_wasm2c_sandbox", %"class.rlbox::rlbox_wasm2c_sandbox"* %this1, i32 0, i32 15
  call void @_ZNSt3mapIjPKvSt4lessIjESaISt4pairIKjS1_EEEC2Ev(%"class.std::map.0"* nonnull dereferenceable(48) %slot_assignments) #3
  ret void
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt18shared_timed_mutexC2Ev(%"class.std::shared_timed_mutex"* nonnull dereferenceable(56) %this) unnamed_addr #8 comdat align 2 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt3mapINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEPvSt4lessIS5_ESaISt4pairIKS5_S6_EEEC2Ev(%"class.std::map.8"* nonnull dereferenceable(48) %this) unnamed_addr #8 comdat align 2 {
entry:
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local void @_ZN5rlbox15app_pointer_mapIjEC2Ev(%"class.rlbox::app_pointer_map"* nonnull dereferenceable(112) %this) unnamed_addr #6 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt6atomicIN5rlbox13rlbox_sandboxINS0_20rlbox_wasm2c_sandboxEE14Sandbox_StatusEEC2ES4_(%"struct.std::atomic"* nonnull dereferenceable(4) %this, i32 %__i) unnamed_addr #8 comdat align 2 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt5mutexC2Ev(%"class.std::mutex"* nonnull dereferenceable(40) %this) unnamed_addr #8 comdat align 2 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt3mapINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEPvSt4lessIS5_ESaISt4pairIKS5_S6_EEED2Ev(%"class.std::map.8"* nonnull dereferenceable(48) %this) unnamed_addr #8 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::map.8"*, align 8
  store %"class.std::map.8"* %this, %"class.std::map.8"** %this.addr, align 8
  %this1 = load %"class.std::map.8"*, %"class.std::map.8"** %this.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZN5rlbox20rlbox_wasm2c_sandboxD2Ev(%"class.rlbox::rlbox_wasm2c_sandbox"* nonnull dereferenceable(2840) %this) unnamed_addr #8 comdat align 2 {
entry:
  %this.addr = alloca %"class.rlbox::rlbox_wasm2c_sandbox"*, align 8
  store %"class.rlbox::rlbox_wasm2c_sandbox"* %this, %"class.rlbox::rlbox_wasm2c_sandbox"** %this.addr, align 8
  %this1 = load %"class.rlbox::rlbox_wasm2c_sandbox"*, %"class.rlbox::rlbox_wasm2c_sandbox"** %this.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt3mapIPKvjSt4lessIS1_ESaISt4pairIKS1_jEEEC2Ev(%"class.std::map"* nonnull dereferenceable(48) %this) unnamed_addr #8 comdat align 2 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt3mapIjPKvSt4lessIjESaISt4pairIKjS1_EEEC2Ev(%"class.std::map.0"* nonnull dereferenceable(48) %this) unnamed_addr #8 comdat align 2 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt8_Rb_treeIPKvSt4pairIKS1_jESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EEC2Ev(%"class.std::_Rb_tree"* nonnull dereferenceable(48) %this) unnamed_addr #8 comdat align 2 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSaISt13_Rb_tree_nodeISt4pairIKPKvjEEEC2Ev(%"class.std::allocator"* nonnull dereferenceable(1) %this) unnamed_addr #8 comdat align 2 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt20_Rb_tree_key_compareISt4lessIPKvEEC2Ev(%"struct.std::_Rb_tree_key_compare"* nonnull dereferenceable(1) %this) unnamed_addr #8 comdat align 2 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt15_Rb_tree_headerC2Ev(%"struct.std::_Rb_tree_header"* nonnull dereferenceable(40) %this) unnamed_addr #8 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
...
terminate.lpad:                                   ; preds = %entry
  ...
  %1 = extractvalue { i8*, i32 } %0, 0
  call void @__clang_call_terminate(i8* %1) #22
  unreachable
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZN9__gnu_cxx13new_allocatorISt13_Rb_tree_nodeISt4pairIKPKvjEEEC2Ev(%"class.__gnu_cxx::new_allocator"* nonnull dereferenceable(1) %this) unnamed_addr #8 comdat align 2 {
entry:
...
define linkonce_odr dso_local void @_ZNSt15_Rb_tree_header8_M_resetEv(%"struct.std::_Rb_tree_header"* nonnull dereferenceable(40) %this) #9 comdat align 2 {
entry:
  %this.addr = alloca %"struct.std::_Rb_tree_header"*, align 8
  store %"struct.std::_Rb_tree_header"* %this, %"struct.std::_Rb_tree_header"** %this.addr, align 8
  %this1 = load %"struct.std::_Rb_tree_header"*, %"struct.std::_Rb_tree_header"** %this.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt8_Rb_treeIjSt4pairIKjPKvESt10_Select1stIS4_ESt4lessIjESaIS4_EEC2Ev(%"class.std::_Rb_tree.1"* nonnull dereferenceable(48) %this) unnamed_addr #8 comdat align 2 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSaISt13_Rb_tree_nodeISt4pairIKjPKvEEEC2Ev(%"class.std::allocator.2"* nonnull dereferenceable(1) %this) unnamed_addr #8 comdat align 2 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt20_Rb_tree_key_compareISt4lessIjEEC2Ev(%"struct.std::_Rb_tree_key_compare.5"* nonnull dereferenceable(1) %this) unnamed_addr #8 comdat align 2 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZN9__gnu_cxx13new_allocatorISt13_Rb_tree_nodeISt4pairIKjPKvEEEC2Ev(%"class.__gnu_cxx::new_allocator.3"* nonnull dereferenceable(1) %this) unnamed_addr #8 comdat align 2 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt22__shared_mutex_pthreadC2Ev(%"class.std::__shared_mutex_pthread"* nonnull dereferenceable(56) %this) unnamed_addr #8 comdat align 2 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt8_Rb_treeINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_PvESt10_Select1stIS9_ESt4lessIS5_ESaIS9_EEC2Ev(%"class.std::_Rb_tree.9"* nonnull dereferenceable(48) %this) unnamed_addr #8 comdat align 2 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSaISt13_Rb_tree_nodeISt4pairIKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEPvEEEC2Ev(%"class.std::allocator.10"* nonnull dereferenceable(1) %this) unnamed_addr #8 comdat align 2 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt20_Rb_tree_key_compareISt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEEC2Ev(%"struct.std::_Rb_tree_key_compare.13"* nonnull dereferenceable(1) %this) unnamed_addr #8 comdat align 2 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZN9__gnu_cxx13new_allocatorISt13_Rb_tree_nodeISt4pairIKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEPvEEEC2Ev(%"class.__gnu_cxx::new_allocator.11"* nonnull dereferenceable(1) %this) unnamed_addr #8 comdat align 2 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt3mapIjPvSt4lessIjESaISt4pairIKjS0_EEEC2Ev(%"class.std::map.16"* nonnull dereferenceable(48) %this) unnamed_addr #8 comdat align 2 {
entry:
...
entry:
  ...
  %ref.tmp11 = alloca %"class.std::tuple.31", align 1
  store %"class.std::map.16"* %this, %"class.std::map.16"** %this.addr, align 8
...
if.then:                                          ; preds = %lor.end
  ...
  call void @_ZSt16forward_as_tupleIJjEESt5tupleIJDpOT_EES3_(%"class.std::tuple"* sret(%"class.std::tuple") align 8 %ref.tmp9, i32* nonnull align 4 dereferenceable(4) %call10) #3
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt3mapIjPvSt4lessIjESaISt4pairIKjS0_EEED2Ev(%"class.std::map.16"* nonnull dereferenceable(48) %this) unnamed_addr #8 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::map.16"*, align 8
  store %"class.std::map.16"* %this, %"class.std::map.16"** %this.addr, align 8
  %this1 = load %"class.std::map.16"*, %"class.std::map.16"** %this.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt8_Rb_treeIjSt4pairIKjPvESt10_Select1stIS3_ESt4lessIjESaIS3_EEC2Ev(%"class.std::_Rb_tree.17"* nonnull dereferenceable(48) %this) unnamed_addr #8 comdat align 2 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSaISt13_Rb_tree_nodeISt4pairIKjPvEEEC2Ev(%"class.std::allocator.18"* nonnull dereferenceable(1) %this) unnamed_addr #8 comdat align 2 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZN9__gnu_cxx13new_allocatorISt13_Rb_tree_nodeISt4pairIKjPvEEEC2Ev(%"class.__gnu_cxx::new_allocator.19"* nonnull dereferenceable(1) %this) unnamed_addr #8 comdat align 2 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local zeroext i1 @_ZSteqRKSt17_Rb_tree_iteratorISt4pairIKjPvEES6_(%"struct.std::_Rb_tree_iterator"* nonnull align 8 dereferenceable(8) %__x, %"struct.std::_Rb_tree_iterator"* nonnull align 8 dereferenceable(8) %__y) #9 comdat {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local %"struct.std::_Rb_tree_node_base"* @_ZNSt3mapIjPvSt4lessIjESaISt4pairIKjS0_EEE3endEv(%"class.std::map.16"* nonnull dereferenceable(48) %this) #9 comdat align 2 {
entry:
  %retval = alloca %"struct.std::_Rb_tree_iterator", align 8
  %this.addr = alloca %"class.std::map.16"*, align 8
  store %"class.std::map.16"* %this, %"class.std::map.16"** %this.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local zeroext i1 @_ZNKSt4lessIjEclERKjS2_(%"struct.std::less.6"* nonnull dereferenceable(1) %this, i32* nonnull align 4 dereferenceable(4) %__x, i32* nonnull align 4 dereferenceable(4) %__y) #9 comdat align 2 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local nonnull align 8 dereferenceable(16) %"struct.std::pair"* @_ZNKSt17_Rb_tree_iteratorISt4pairIKjPvEEdeEv(%"struct.std::_Rb_tree_iterator"* nonnull dereferenceable(8) %this) #9 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
...
entry:
  ...
  %__args.addr4 = alloca %"class.std::tuple.31"*, align 8
  ...
  store %"class.std::tuple.31"* %__args3, %"class.std::tuple.31"** %__args.addr4, align 8
...
invoke.cont11:                                    ; preds = %invoke.cont
  %7 = bitcast %"struct.std::pair.32"* %__res to { %"struct.std::_Rb_tree_node_base"*, %"struct.std::_Rb_tree_node_base"* }*
  ...
  %second = getelementptr inbounds %"struct.std::pair.32", %"struct.std::pair.32"* %__res, i32 0, i32 1
...
if.then:                                          ; preds = %invoke.cont11
  %first = getelementptr inbounds %"struct.std::pair.32", %"struct.std::pair.32"* %__res, i32 0, i32 0
  %13 = load %"struct.std::_Rb_tree_node_base"*, %"struct.std::_Rb_tree_node_base"** %first, align 8
  %second13 = getelementptr inbounds %"struct.std::pair.32", %"struct.std::pair.32"* %__res, i32 0, i32 1
...
if.end:                                           ; preds = %invoke.cont11
  ...
  %first17 = getelementptr inbounds %"struct.std::pair.32", %"struct.std::pair.32"* %__res, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt23_Rb_tree_const_iteratorISt4pairIKjPvEEC2ERKSt17_Rb_tree_iteratorIS3_E(%"struct.std::_Rb_tree_const_iterator"* nonnull dereferenceable(8) %this, %"struct.std::_Rb_tree_iterator"* nonnull align 8 dereferenceable(8) %__it) unnamed_addr #8 comdat align 2 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local void @_ZSt16forward_as_tupleIJjEESt5tupleIJDpOT_EES3_(%"class.std::tuple"* noalias sret(%"class.std::tuple") align 8 %agg.result, i32* nonnull align 4 dereferenceable(4) %__args) #9 comdat personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local nonnull align 4 dereferenceable(4) i32* @_ZSt4moveIRjEONSt16remove_referenceIT_E4typeEOS2_(i32* nonnull align 4 dereferenceable(4) %__t) #9 comdat {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local %"struct.std::_Rb_tree_node"* @_ZNSt8_Rb_treeIjSt4pairIKjPvESt10_Select1stIS3_ESt4lessIjESaIS3_EE8_M_beginEv(%"class.std::_Rb_tree.17"* nonnull dereferenceable(48) %this) #9 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::_Rb_tree.17"*, align 8
  store %"class.std::_Rb_tree.17"* %this, %"class.std::_Rb_tree.17"** %this.addr, align 8
  %this1 = load %"class.std::_Rb_tree.17"*, %"class.std::_Rb_tree.17"** %this.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local %"struct.std::_Rb_tree_node_base"* @_ZNSt8_Rb_treeIjSt4pairIKjPvESt10_Select1stIS3_ESt4lessIjESaIS3_EE6_M_endEv(%"class.std::_Rb_tree.17"* nonnull dereferenceable(48) %this) #9 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::_Rb_tree.17"*, align 8
  store %"class.std::_Rb_tree.17"* %this, %"class.std::_Rb_tree.17"** %this.addr, align 8
  %this1 = load %"class.std::_Rb_tree.17"*, %"class.std::_Rb_tree.17"** %this.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local %"struct.std::_Rb_tree_node"* @_ZNSt8_Rb_treeIjSt4pairIKjPvESt10_Select1stIS3_ESt4lessIjESaIS3_EE7_S_leftEPSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_node_base"* %__x) #9 comdat align 2 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local %"struct.std::_Rb_tree_node"* @_ZNSt8_Rb_treeIjSt4pairIKjPvESt10_Select1stIS3_ESt4lessIjESaIS3_EE8_S_rightEPSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_node_base"* %__x) #9 comdat align 2 {
entry:
  %__x.addr = alloca %"struct.std::_Rb_tree_node_base"*, align 8
  store %"struct.std::_Rb_tree_node_base"* %__x, %"struct.std::_Rb_tree_node_base"** %__x.addr, align 8
  %0 = load %"struct.std::_Rb_tree_node_base"*, %"struct.std::_Rb_tree_node_base"** %__x.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt17_Rb_tree_iteratorISt4pairIKjPvEEC2EPSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_iterator"* nonnull dereferenceable(8) %this, %"struct.std::_Rb_tree_node_base"* %__x) unnamed_addr #8 comdat align 2 {
entry:
  %this.addr = alloca %"struct.std::_Rb_tree_iterator"*, align 8
  %__x.addr = alloca %"struct.std::_Rb_tree_node_base"*, align 8
  store %"struct.std::_Rb_tree_iterator"* %this, %"struct.std::_Rb_tree_iterator"** %this.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local nonnull align 4 dereferenceable(4) i32* @_ZNKSt10_Select1stISt4pairIKjPvEEclERKS3_(%"struct.std::_Select1st"* nonnull dereferenceable(1) %this, %"struct.std::pair"* nonnull align 8 dereferenceable(16) %__x) #9 comdat align 2 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local %"struct.std::pair"* @_ZNKSt13_Rb_tree_nodeISt4pairIKjPvEE9_M_valptrEv(%"struct.std::_Rb_tree_node"* nonnull dereferenceable(48) %this) #9 comdat align 2 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local %"struct.std::pair"* @_ZNK9__gnu_cxx16__aligned_membufISt4pairIKjPvEE6_M_ptrEv(%"struct.__gnu_cxx::__aligned_membuf"* nonnull dereferenceable(16) %this) #9 comdat align 2 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local i8* @_ZNK9__gnu_cxx16__aligned_membufISt4pairIKjPvEE7_M_addrEv(%"struct.__gnu_cxx::__aligned_membuf"* nonnull dereferenceable(16) %this) #9 comdat align 2 {
entry:
  %this.addr = alloca %"struct.__gnu_cxx::__aligned_membuf"*, align 8
  store %"struct.__gnu_cxx::__aligned_membuf"* %this, %"struct.__gnu_cxx::__aligned_membuf"** %this.addr, align 8
  %this1 = load %"struct.__gnu_cxx::__aligned_membuf"*, %"struct.__gnu_cxx::__aligned_membuf"** %this.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local %"struct.std::_Rb_tree_node_base"* @_ZNSt8_Rb_treeIjSt4pairIKjPvESt10_Select1stIS3_ESt4lessIjESaIS3_EE3endEv(%"class.std::_Rb_tree.17"* nonnull dereferenceable(48) %this) #9 comdat align 2 {
entry:
  %retval = alloca %"struct.std::_Rb_tree_iterator", align 8
  %this.addr = alloca %"class.std::_Rb_tree.17"*, align 8
  store %"class.std::_Rb_tree.17"* %this, %"class.std::_Rb_tree.17"** %this.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local void @_ZNKSt8_Rb_treeIjSt4pairIKjPvESt10_Select1stIS3_ESt4lessIjESaIS3_EE8key_compEv(%"class.std::_Rb_tree.17"* nonnull dereferenceable(48) %this) #9 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::_Rb_tree.17"*, align 8
  store %"class.std::_Rb_tree.17"* %this, %"class.std::_Rb_tree.17"** %this.addr, align 8
  %this1 = load %"class.std::_Rb_tree.17"*, %"class.std::_Rb_tree.17"** %this.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local %"struct.std::pair"* @_ZNSt13_Rb_tree_nodeISt4pairIKjPvEE9_M_valptrEv(%"struct.std::_Rb_tree_node"* nonnull dereferenceable(48) %this) #9 comdat align 2 {
entry:
  %this.addr = alloca %"struct.std::_Rb_tree_node"*, align 8
  store %"struct.std::_Rb_tree_node"* %this, %"struct.std::_Rb_tree_node"** %this.addr, align 8
  %this1 = load %"struct.std::_Rb_tree_node"*, %"struct.std::_Rb_tree_node"** %this.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local %"struct.std::pair"* @_ZN9__gnu_cxx16__aligned_membufISt4pairIKjPvEE6_M_ptrEv(%"struct.__gnu_cxx::__aligned_membuf"* nonnull dereferenceable(16) %this) #9 comdat align 2 {
entry:
  %this.addr = alloca %"struct.__gnu_cxx::__aligned_membuf"*, align 8
  store %"struct.__gnu_cxx::__aligned_membuf"* %this, %"struct.__gnu_cxx::__aligned_membuf"** %this.addr, align 8
  %this1 = load %"struct.__gnu_cxx::__aligned_membuf"*, %"struct.__gnu_cxx::__aligned_membuf"** %this.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local i8* @_ZN9__gnu_cxx16__aligned_membufISt4pairIKjPvEE7_M_addrEv(%"struct.__gnu_cxx::__aligned_membuf"* nonnull dereferenceable(16) %this) #9 comdat align 2 {
entry:
  %this.addr = alloca %"struct.__gnu_cxx::__aligned_membuf"*, align 8
  store %"struct.__gnu_cxx::__aligned_membuf"* %this, %"struct.__gnu_cxx::__aligned_membuf"** %this.addr, align 8
  %this1 = load %"struct.__gnu_cxx::__aligned_membuf"*, %"struct.__gnu_cxx::__aligned_membuf"** %this.addr, align 8
...
entry:
  ...
  %3 = load %"class.std::tuple.31"*, %"class.std::tuple.31"** %__args.addr4, align 8
  %call8 = call nonnull align 1 dereferenceable(1) %"class.std::tuple.31"* @_ZSt7forwardISt5tupleIJEEEOT_RNSt16remove_referenceIS2_E4typeE(%"class.std::tuple.31"* nonnull align 1 dereferenceable(1) %3) #3
  call void @_ZNSt8_Rb_treeIjSt4pairIKjPvESt10_Select1stIS3_ESt4lessIjESaIS3_EE17_M_construct_nodeIJRKSt21piecewise_construct_tSt5tupleIJOjEESE_IJEEEEEvPSt13_Rb_tree_nodeIS3_EDpOT_(%"class.std::_Rb_tree.17"* nonnull dereferenceable(48) %this5, %"struct.std::_Rb_tree_node"* %0, %"struct.std::piecewise_construct_t"* nonnull align 1 dereferenceable(1) %call6, %"class.std::tuple"* nonnull align 8 dereferenceable(8) %call7, %"class.std::tuple.31"* nonnull align 1 dereferenceable(1) %call8)
  %4 = load %"struct.std::_Rb_tree_node"*, %"struct.std::_Rb_tree_node"** %__tmp, align 8
  ret %"struct.std::_Rb_tree_node"* %4
}

; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local nonnull align 1 dereferenceable(1) %"struct.std::piecewise_construct_t"* @_ZSt7forwardIRKSt21piecewise_construct_tEOT_RNSt16remove_referenceIS3_E4typeE(%"struct.std::piecewise_construct_t"* nonnull align 1 dereferenceable(1) %__t) #9 comdat {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local nonnull align 8 dereferenceable(8) %"class.std::tuple"* @_ZSt7forwardISt5tupleIJOjEEEOT_RNSt16remove_referenceIS3_E4typeE(%"class.std::tuple"* nonnull align 8 dereferenceable(8) %__t) #9 comdat {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local nonnull align 1 dereferenceable(1) %"class.std::tuple.31"* @_ZSt7forwardISt5tupleIJEEEOT_RNSt16remove_referenceIS2_E4typeE(%"class.std::tuple.31"* nonnull align 1 dereferenceable(1) %__t) #9 comdat {
entry:
  %__t.addr = alloca %"class.std::tuple.31"*, align 8
  store %"class.std::tuple.31"* %__t, %"class.std::tuple.31"** %__t.addr, align 8
  %0 = load %"class.std::tuple.31"*, %"class.std::tuple.31"** %__t.addr, align 8
...
if.then9:                                         ; preds = %land.lhs.true
  ...
  call void @_ZNSt4pairIPSt18_Rb_tree_node_baseS1_EC2IRS1_Lb1EEERKS1_OT_(%"struct.std::pair.32"* nonnull dereferenceable(16) %retval, %"struct.std::_Rb_tree_node_base"** nonnull align 8 dereferenceable(8) %ref.tmp, %"struct.std::_Rb_tree_node_base"** nonnull align 8 dereferenceable(8) %call10)
  br label %return
...
if.else:                                          ; preds = %land.lhs.true, %if.then
  ...
  %5 = bitcast %"struct.std::pair.32"* %retval to { %"struct.std::_Rb_tree_node_base"*, %"struct.std::_Rb_tree_node_base"* }*
...
if.then22:                                        ; preds = %if.then18
  ...
  call void @_ZNSt4pairIPSt18_Rb_tree_node_baseS1_EC2IRS1_S4_Lb1EEEOT_OT0_(%"struct.std::pair.32"* nonnull dereferenceable(16) %retval, %"struct.std::_Rb_tree_node_base"** nonnull align 8 dereferenceable(8) %call23, %"struct.std::_Rb_tree_node_base"** nonnull align 8 dereferenceable(8) %call24)
  br label %return
...
if.then36:                                        ; preds = %if.then32
  ...
  call void @_ZNSt4pairIPSt18_Rb_tree_node_baseS1_EC2IRS1_Lb1EEERKS1_OT_(%"struct.std::pair.32"* nonnull dereferenceable(16) %retval, %"struct.std::_Rb_tree_node_base"** nonnull align 8 dereferenceable(8) %ref.tmp37, %"struct.std::_Rb_tree_node_base"** nonnull align 8 dereferenceable(8) %_M_node38)
  br label %return
...
if.else39:                                        ; preds = %if.then32
  ...
  call void @_ZNSt4pairIPSt18_Rb_tree_node_baseS1_EC2IRS1_S4_Lb1EEEOT_OT0_(%"struct.std::pair.32"* nonnull dereferenceable(16) %retval, %"struct.std::_Rb_tree_node_base"** nonnull align 8 dereferenceable(8) %_M_node40, %"struct.std::_Rb_tree_node_base"** nonnull align 8 dereferenceable(8) %_M_node41)
  br label %return
...
if.else42:                                        ; preds = %if.else25
  ...
  %22 = bitcast %"struct.std::pair.32"* %retval to { %"struct.std::_Rb_tree_node_base"*, %"struct.std::_Rb_tree_node_base"* }*
...
if.then54:                                        ; preds = %if.then50
  ...
  call void @_ZNSt4pairIPSt18_Rb_tree_node_baseS1_EC2IRS1_Lb1EEERKS1_OT_(%"struct.std::pair.32"* nonnull dereferenceable(16) %retval, %"struct.std::_Rb_tree_node_base"** nonnull align 8 dereferenceable(8) %ref.tmp55, %"struct.std::_Rb_tree_node_base"** nonnull align 8 dereferenceable(8) %call56)
  br label %return
...
if.then68:                                        ; preds = %if.then64
  ...
  call void @_ZNSt4pairIPSt18_Rb_tree_node_baseS1_EC2IRS1_Lb1EEERKS1_OT_(%"struct.std::pair.32"* nonnull dereferenceable(16) %retval, %"struct.std::_Rb_tree_node_base"** nonnull align 8 dereferenceable(8) %ref.tmp69, %"struct.std::_Rb_tree_node_base"** nonnull align 8 dereferenceable(8) %_M_node70)
  br label %return
...
if.else71:                                        ; preds = %if.then64
  ...
  call void @_ZNSt4pairIPSt18_Rb_tree_node_baseS1_EC2IRS1_S4_Lb1EEEOT_OT0_(%"struct.std::pair.32"* nonnull dereferenceable(16) %retval, %"struct.std::_Rb_tree_node_base"** nonnull align 8 dereferenceable(8) %_M_node72, %"struct.std::_Rb_tree_node_base"** nonnull align 8 dereferenceable(8) %_M_node73)
  br label %return
...
if.else74:                                        ; preds = %if.else57
  ...
  %39 = bitcast %"struct.std::pair.32"* %retval to { %"struct.std::_Rb_tree_node_base"*, %"struct.std::_Rb_tree_node_base"* }*
...
if.else76:                                        ; preds = %if.else44
  ...
  call void @_ZNSt4pairIPSt18_Rb_tree_node_baseS1_EC2IRS1_Lb1EEEOT_RKS1_(%"struct.std::pair.32"* nonnull dereferenceable(16) %retval, %"struct.std::_Rb_tree_node_base"** nonnull align 8 dereferenceable(8) %_M_node77, %"struct.std::_Rb_tree_node_base"** nonnull align 8 dereferenceable(8) %ref.tmp78)
  br label %return

return:                                           ; preds = %if.else76, %if.else74, %if.else71, %if.then68, %if.then54, %if.else42, %if.else39, %if.then36, %if.then22, %if.else, %if.then9
  %44 = bitcast %"struct.std::pair.32"* %retval to { %"struct.std::_Rb_tree_node_base"*, %"struct.std::_Rb_tree_node_base"* }*
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local void @_ZNSt8_Rb_treeIjSt4pairIKjPvESt10_Select1stIS3_ESt4lessIjESaIS3_EE12_M_drop_nodeEPSt13_Rb_tree_nodeIS3_E(%"class.std::_Rb_tree.17"* nonnull dereferenceable(48) %this, %"struct.std::_Rb_tree_node"* %__p) #9 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::_Rb_tree.17"*, align 8
...
terminate.lpad:                                   ; preds = %lpad10
  ...
  %17 = extractvalue { i8*, i32 } %16, 0
  call void @__clang_call_terminate(i8* %17) #22
  unreachable
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local nonnull align 1 dereferenceable(1) %"class.std::allocator.18"* @_ZNSt8_Rb_treeIjSt4pairIKjPvESt10_Select1stIS3_ESt4lessIjESaIS3_EE21_M_get_Node_allocatorEv(%"class.std::_Rb_tree.17"* nonnull dereferenceable(48) %this) #9 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::_Rb_tree.17"*, align 8
  store %"class.std::_Rb_tree.17"* %this, %"class.std::_Rb_tree.17"** %this.addr, align 8
  %this1 = load %"class.std::_Rb_tree.17"*, %"class.std::_Rb_tree.17"** %this.addr, align 8
...
if.end:                                           ; preds = %entry
  %2 = load i64, i64* %__n.addr, align 8
  %mul = mul i64 %2, 48
  %call2 = call noalias nonnull i8* @_Znwm(i64 %mul) #24
  %3 = bitcast i8* %call2 to %"struct.std::_Rb_tree_node"*
  ret %"struct.std::_Rb_tree_node"* %3
}

; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local i64 @_ZNK9__gnu_cxx13new_allocatorISt13_Rb_tree_nodeISt4pairIKjPvEEE8max_sizeEv(%"class.__gnu_cxx::new_allocator.19"* nonnull dereferenceable(1) %this) #9 comdat align 2 {
entry:
  %this.addr = alloca %"class.__gnu_cxx::new_allocator.19"*, align 8
  store %"class.__gnu_cxx::new_allocator.19"* %this, %"class.__gnu_cxx::new_allocator.19"** %this.addr, align 8
  %this1 = load %"class.__gnu_cxx::new_allocator.19"*, %"class.__gnu_cxx::new_allocator.19"** %this.addr, align 8
...
entry:
  ...
  %5 = load %"class.std::tuple.31"*, %"class.std::tuple.31"** %__args.addr4, align 8
  %call6 = call nonnull align 1 dereferenceable(1) %"class.std::tuple.31"* @_ZSt7forwardISt5tupleIJEEEOT_RNSt16remove_referenceIS2_E4typeE(%"class.std::tuple.31"* nonnull align 1 dereferenceable(1) %5) #3
  call void @_ZN9__gnu_cxx13new_allocatorISt13_Rb_tree_nodeISt4pairIKjPvEEE9constructIS5_JRKSt21piecewise_construct_tSt5tupleIJOjEESC_IJEEEEEvPT_DpOT0_(%"class.__gnu_cxx::new_allocator.19"* nonnull dereferenceable(1) %1, %"struct.std::pair"* %2, %"struct.std::piecewise_construct_t"* nonnull align 1 dereferenceable(1) %call, %"class.std::tuple"* nonnull align 8 dereferenceable(8) %call5, %"class.std::tuple.31"* nonnull align 1 dereferenceable(1) %call6)
  ret void
}

; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local void @_ZNSt8_Rb_treeIjSt4pairIKjPvESt10_Select1stIS3_ESt4lessIjESaIS3_EE11_M_put_nodeEPSt13_Rb_tree_nodeIS3_E(%"class.std::_Rb_tree.17"* nonnull dereferenceable(48) %this, %"struct.std::_Rb_tree_node"* %__p) #9 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
  %this.addr = alloca %"class.std::_Rb_tree.17"*, align 8
  %__p.addr = alloca %"struct.std::_Rb_tree_node"*, align 8
  store %"class.std::_Rb_tree.17"* %this, %"class.std::_Rb_tree.17"** %this.addr, align 8
...
terminate.lpad:                                   ; preds = %entry
  ...
  %2 = extractvalue { i8*, i32 } %1, 0
  call void @__clang_call_terminate(i8* %2) #22
  unreachable
}
...
entry:
  ...
  %agg.tmp8 = alloca %"class.std::tuple.31", align 1
  store %"class.__gnu_cxx::new_allocator.19"* %this, %"class.__gnu_cxx::new_allocator.19"** %this.addr, align 8
  store %"struct.std::pair"* %__p, %"struct.std::pair"** %__p.addr, align 8
  store %"struct.std::piecewise_construct_t"* %__args, %"struct.std::piecewise_construct_t"** %__args.addr, align 8
  store %"class.std::tuple"* %__args1, %"class.std::tuple"** %__args.addr2, align 8
  ...
  %5 = load %"class.std::tuple.31"*, %"class.std::tuple.31"** %__args.addr4, align 8
  %call9 = call nonnull align 1 dereferenceable(1) %"class.std::tuple.31"* @_ZSt7forwardISt5tupleIJEEEOT_RNSt16remove_referenceIS2_E4typeE(%"class.std::tuple.31"* nonnull align 1 dereferenceable(1) %5) #3
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt5tupleIJOjEEC2EOS1_(%"class.std::tuple"* nonnull dereferenceable(8) %this, %"class.std::tuple"* nonnull align 8 dereferenceable(8) %0) unnamed_addr #8 comdat align 2 {
entry:
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local void @_ZNSt4pairIKjPvEC2IJOjEJEEESt21piecewise_construct_tSt5tupleIJDpT_EES6_IJDpT0_EE(%"struct.std::pair"* nonnull dereferenceable(16) %this, %"class.std::tuple"* %__first) unnamed_addr #6 comdat align 2 {
entry:
  %0 = alloca %"struct.std::piecewise_construct_t", align 1
  %__second = alloca %"class.std::tuple.31", align 1
  ...
  call void @_ZNSt4pairIKjPvEC2IJOjEJLm0EEJEJEEERSt5tupleIJDpT_EERS5_IJDpT1_EESt12_Index_tupleIJXspT0_EEESE_IJXspT2_EEE(%"struct.std::pair"* nonnull dereferenceable(16) %this2, %"class.std::tuple"* nonnull align 8 dereferenceable(8) %__first, %"class.std::tuple.31"* nonnull align 1 dereferenceable(1) %__second)
  ret void
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt11_Tuple_implILm0EJOjEEC2EOS1_(%"struct.std::_Tuple_impl"* nonnull dereferenceable(8) %this, %"struct.std::_Tuple_impl"* nonnull align 8 dereferenceable(8) %__in) unnamed_addr #8 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local nonnull align 4 dereferenceable(4) i32* @_ZSt7forwardIOjEOT_RNSt16remove_referenceIS1_E4typeE(i32* nonnull align 4 dereferenceable(4) %__t) #9 comdat {
entry:
  %__t.addr = alloca i32*, align 8
  store i32* %__t, i32** %__t.addr, align 8
  %0 = load i32*, i32** %__t.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local nonnull align 4 dereferenceable(4) i32* @_ZNSt11_Tuple_implILm0EJOjEE7_M_headERS1_(%"struct.std::_Tuple_impl"* nonnull align 8 dereferenceable(8) %__t) #9 comdat align 2 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt10_Head_baseILm0EOjLb0EEC2IjEEOT_(%"struct.std::_Head_base"* nonnull dereferenceable(8) %this, i32* nonnull align 4 dereferenceable(4) %__h) unnamed_addr #8 comdat align 2 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local nonnull align 4 dereferenceable(4) i32* @_ZNSt10_Head_baseILm0EOjLb0EE7_M_headERS1_(%"struct.std::_Head_base"* nonnull align 8 dereferenceable(8) %__b) #9 comdat align 2 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local nonnull align 4 dereferenceable(4) i32* @_ZSt7forwardIjEOT_RNSt16remove_referenceIS0_E4typeE(i32* nonnull align 4 dereferenceable(4) %__t) #9 comdat {
entry:
  %__t.addr = alloca i32*, align 8
  store i32* %__t, i32** %__t.addr, align 8
  %0 = load i32*, i32** %__t.addr, align 8
...
entry:
  ...
  %__tuple2.addr = alloca %"class.std::tuple.31"*, align 8
  store %"struct.std::pair"* %this, %"struct.std::pair"** %this.addr, align 8
  store %"class.std::tuple"* %__tuple1, %"class.std::tuple"** %__tuple1.addr, align 8
  store %"class.std::tuple.31"* %__tuple2, %"class.std::tuple.31"** %__tuple2.addr, align 8
  %this2 = load %"struct.std::pair"*, %"struct.std::pair"** %this.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local nonnull align 4 dereferenceable(4) i32* @_ZSt3getILm0EJOjEERNSt13tuple_elementIXT_ESt5tupleIJDpT0_EEE4typeERS5_(%"class.std::tuple"* nonnull align 8 dereferenceable(8) %__t) #9 comdat {
entry:
  %__t.addr = alloca %"class.std::tuple"*, align 8
  store %"class.std::tuple"* %__t, %"class.std::tuple"** %__t.addr, align 8
  %0 = load %"class.std::tuple"*, %"class.std::tuple"** %__t.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local nonnull align 4 dereferenceable(4) i32* @_ZSt12__get_helperILm0EOjJEERT0_RSt11_Tuple_implIXT_EJS1_DpT1_EE(%"struct.std::_Tuple_impl"* nonnull align 8 dereferenceable(8) %__t) #9 comdat {
entry:
  %__t.addr = alloca %"struct.std::_Tuple_impl"*, align 8
  store %"struct.std::_Tuple_impl"* %__t, %"struct.std::_Tuple_impl"** %__t.addr, align 8
  %0 = load %"struct.std::_Tuple_impl"*, %"struct.std::_Tuple_impl"** %__t.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local void @_ZN9__gnu_cxx13new_allocatorISt13_Rb_tree_nodeISt4pairIKjPvEEE10deallocateEPS6_m(%"class.__gnu_cxx::new_allocator.19"* nonnull dereferenceable(1) %this, %"struct.std::_Rb_tree_node"* %__p, i64 %0) #9 comdat align 2 {
entry:
  %this.addr = alloca %"class.__gnu_cxx::new_allocator.19"*, align 8
  %__p.addr = alloca %"struct.std::_Rb_tree_node"*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local %"struct.std::_Rb_tree_node_base"* @_ZNKSt23_Rb_tree_const_iteratorISt4pairIKjPvEE13_M_const_castEv(%"struct.std::_Rb_tree_const_iterator"* nonnull dereferenceable(8) %this) #9 comdat align 2 {
entry:
  %retval = alloca %"struct.std::_Rb_tree_iterator", align 8
  %this.addr = alloca %"struct.std::_Rb_tree_const_iterator"*, align 8
  store %"struct.std::_Rb_tree_const_iterator"* %this, %"struct.std::_Rb_tree_const_iterator"** %this.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local i64 @_ZNKSt8_Rb_treeIjSt4pairIKjPvESt10_Select1stIS3_ESt4lessIjESaIS3_EE4sizeEv(%"class.std::_Rb_tree.17"* nonnull dereferenceable(48) %this) #9 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::_Rb_tree.17"*, align 8
  store %"class.std::_Rb_tree.17"* %this, %"class.std::_Rb_tree.17"** %this.addr, align 8
  %this1 = load %"class.std::_Rb_tree.17"*, %"class.std::_Rb_tree.17"** %this.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local nonnull align 8 dereferenceable(8) %"struct.std::_Rb_tree_node_base"** @_ZNSt8_Rb_treeIjSt4pairIKjPvESt10_Select1stIS3_ESt4lessIjESaIS3_EE12_M_rightmostEv(%"class.std::_Rb_tree.17"* nonnull dereferenceable(48) %this) #9 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::_Rb_tree.17"*, align 8
  store %"class.std::_Rb_tree.17"* %this, %"class.std::_Rb_tree.17"** %this.addr, align 8
  %this1 = load %"class.std::_Rb_tree.17"*, %"class.std::_Rb_tree.17"** %this.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt4pairIPSt18_Rb_tree_node_baseS1_EC2IRS1_Lb1EEERKS1_OT_(%"struct.std::pair.32"* nonnull dereferenceable(16) %this, %"struct.std::_Rb_tree_node_base"** nonnull align 8 dereferenceable(8) %__x, %"struct.std::_Rb_tree_node_base"** nonnull align 8 dereferenceable(8) %__y) unnamed_addr #8 comdat align 2 {
entry:
  ...
  %0 = bitcast %"struct.std::pair.32"* %this1 to %"class.std::__pair_base.33"*
  %first = getelementptr inbounds %"struct.std::pair.32", %"struct.std::pair.32"* %this1, i32 0, i32 0
  ...
  %second = getelementptr inbounds %"struct.std::pair.32", %"struct.std::pair.32"* %this1, i32 0, i32 1
...
if.then10:                                        ; preds = %if.then
  call void @_ZNSt4pairIPSt18_Rb_tree_node_baseS1_EC2IRPSt13_Rb_tree_nodeIS_IKjPvEERS1_Lb1EEEOT_OT0_(%"struct.std::pair.32"* nonnull dereferenceable(16) %retval, %"struct.std::_Rb_tree_node"** nonnull align 8 dereferenceable(8) %__x, %"struct.std::_Rb_tree_node_base"** nonnull align 8 dereferenceable(8) %__y)
  br label %return
...
if.end18:                                         ; preds = %if.end12
  ...
  call void @_ZNSt4pairIPSt18_Rb_tree_node_baseS1_EC2IRS1_Lb1EEEOT_RKS1_(%"struct.std::pair.32"* nonnull dereferenceable(16) %retval, %"struct.std::_Rb_tree_node_base"** nonnull align 8 dereferenceable(8) %_M_node19, %"struct.std::_Rb_tree_node_base"** nonnull align 8 dereferenceable(8) %ref.tmp20)
  br label %return

return:                                           ; preds = %if.end18, %if.then17, %if.then10
  %16 = bitcast %"struct.std::pair.32"* %retval to { %"struct.std::_Rb_tree_node_base"*, %"struct.std::_Rb_tree_node_base"* }*
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local nonnull align 8 dereferenceable(8) %"struct.std::_Rb_tree_node_base"** @_ZNSt8_Rb_treeIjSt4pairIKjPvESt10_Select1stIS3_ESt4lessIjESaIS3_EE11_M_leftmostEv(%"class.std::_Rb_tree.17"* nonnull dereferenceable(48) %this) #9 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::_Rb_tree.17"*, align 8
  store %"class.std::_Rb_tree.17"* %this, %"class.std::_Rb_tree.17"** %this.addr, align 8
  %this1 = load %"class.std::_Rb_tree.17"*, %"class.std::_Rb_tree.17"** %this.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt4pairIPSt18_Rb_tree_node_baseS1_EC2IRS1_S4_Lb1EEEOT_OT0_(%"struct.std::pair.32"* nonnull dereferenceable(16) %this, %"struct.std::_Rb_tree_node_base"** nonnull align 8 dereferenceable(8) %__x, %"struct.std::_Rb_tree_node_base"** nonnull align 8 dereferenceable(8) %__y) unnamed_addr #8 comdat align 2 {
entry:
  %this.addr = alloca %"struct.std::pair.32"*, align 8
  %__x.addr = alloca %"struct.std::_Rb_tree_node_base"**, align 8
  %__y.addr = alloca %"struct.std::_Rb_tree_node_base"**, align 8
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local nonnull align 8 dereferenceable(8) %"struct.std::_Rb_tree_iterator"* @_ZNSt17_Rb_tree_iteratorISt4pairIKjPvEEmmEv(%"struct.std::_Rb_tree_iterator"* nonnull dereferenceable(8) %this) #9 comdat align 2 {
entry:
  %this.addr = alloca %"struct.std::_Rb_tree_iterator"*, align 8
  store %"struct.std::_Rb_tree_iterator"* %this, %"struct.std::_Rb_tree_iterator"** %this.addr, align 8
  %this1 = load %"struct.std::_Rb_tree_iterator"*, %"struct.std::_Rb_tree_iterator"** %this.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local nonnull align 8 dereferenceable(8) %"struct.std::_Rb_tree_iterator"* @_ZNSt17_Rb_tree_iteratorISt4pairIKjPvEEppEv(%"struct.std::_Rb_tree_iterator"* nonnull dereferenceable(8) %this) #9 comdat align 2 {
entry:
  %this.addr = alloca %"struct.std::_Rb_tree_iterator"*, align 8
  store %"struct.std::_Rb_tree_iterator"* %this, %"struct.std::_Rb_tree_iterator"** %this.addr, align 8
  %this1 = load %"struct.std::_Rb_tree_iterator"*, %"struct.std::_Rb_tree_iterator"** %this.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt4pairIPSt18_Rb_tree_node_baseS1_EC2IRS1_Lb1EEEOT_RKS1_(%"struct.std::pair.32"* nonnull dereferenceable(16) %this, %"struct.std::_Rb_tree_node_base"** nonnull align 8 dereferenceable(8) %__x, %"struct.std::_Rb_tree_node_base"** nonnull align 8 dereferenceable(8) %__y) unnamed_addr #8 comdat align 2 {
entry:
  %this.addr = alloca %"struct.std::pair.32"*, align 8
  %__x.addr = alloca %"struct.std::_Rb_tree_node_base"**, align 8
  %__y.addr = alloca %"struct.std::_Rb_tree_node_base"**, align 8
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local nonnull align 8 dereferenceable(8) %"struct.std::_Rb_tree_node_base"** @_ZSt7forwardIRPSt18_Rb_tree_node_baseEOT_RNSt16remove_referenceIS3_E4typeE(%"struct.std::_Rb_tree_node_base"** nonnull align 8 dereferenceable(8) %__t) #9 comdat {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local %"struct.std::_Rb_tree_node_base"* @_ZNSt8_Rb_treeIjSt4pairIKjPvESt10_Select1stIS3_ESt4lessIjESaIS3_EE5beginEv(%"class.std::_Rb_tree.17"* nonnull dereferenceable(48) %this) #9 comdat align 2 {
entry:
  %retval = alloca %"struct.std::_Rb_tree_iterator", align 8
  %this.addr = alloca %"class.std::_Rb_tree.17"*, align 8
  store %"class.std::_Rb_tree.17"* %this, %"class.std::_Rb_tree.17"** %this.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt4pairIPSt18_Rb_tree_node_baseS1_EC2IRPSt13_Rb_tree_nodeIS_IKjPvEERS1_Lb1EEEOT_OT0_(%"struct.std::pair.32"* nonnull dereferenceable(16) %this, %"struct.std::_Rb_tree_node"** nonnull align 8 dereferenceable(8) %__x, %"struct.std::_Rb_tree_node_base"** nonnull align 8 dereferenceable(8) %__y) unnamed_addr #8 comdat align 2 {
entry:
  %this.addr = alloca %"struct.std::pair.32"*, align 8
  %__x.addr = alloca %"struct.std::_Rb_tree_node"**, align 8
  %__y.addr = alloca %"struct.std::_Rb_tree_node_base"**, align 8
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local nonnull align 8 dereferenceable(8) %"struct.std::_Rb_tree_node"** @_ZSt7forwardIRPSt13_Rb_tree_nodeISt4pairIKjPvEEEOT_RNSt16remove_referenceIS8_E4typeE(%"struct.std::_Rb_tree_node"** nonnull align 8 dereferenceable(8) %__t) #9 comdat {
entry:
...
declare dso_local void @_ZSt29_Rb_tree_insert_and_rebalancebPSt18_Rb_tree_node_baseS0_RS_(i1 zeroext, %"struct.std::_Rb_tree_node_base"*, %"struct.std::_Rb_tree_node_base"*, %"struct.std::_Rb_tree_node_base"* nonnull align 8 dereferenceable(32)) #16

; Function Attrs: noinline nounwind optnone tainted uwtable mustprogress
define linkonce_odr dso_local void @_ZNSt8_Rb_treeIjSt4pairIKjPvESt10_Select1stIS3_ESt4lessIjESaIS3_EE15_M_destroy_nodeEPSt13_Rb_tree_nodeIS3_E(%"class.std::_Rb_tree.17"* nonnull dereferenceable(48) %this, %"struct.std::_Rb_tree_node"* %__p) #17 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::_Rb_tree.17"*, align 8
  %__p.addr = alloca %"struct.std::_Rb_tree_node"*, align 8
  store %"class.std::_Rb_tree.17"* %this, %"class.std::_Rb_tree.17"** %this.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local void @_ZNSt16allocator_traitsISaISt13_Rb_tree_nodeISt4pairIKjPvEEEE7destroyIS4_EEvRS6_PT_(%"class.std::allocator.18"* nonnull align 1 dereferenceable(1) %__a, %"struct.std::pair"* %__p) #9 comdat align 2 {
entry:
  %__a.addr = alloca %"class.std::allocator.18"*, align 8
  %__p.addr = alloca %"struct.std::pair"*, align 8
  store %"class.std::allocator.18"* %__a, %"class.std::allocator.18"** %__a.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local void @_ZN9__gnu_cxx13new_allocatorISt13_Rb_tree_nodeISt4pairIKjPvEEE7destroyIS5_EEvPT_(%"class.__gnu_cxx::new_allocator.19"* nonnull dereferenceable(1) %this, %"struct.std::pair"* %__p) #9 comdat align 2 {
entry:
  %this.addr = alloca %"class.__gnu_cxx::new_allocator.19"*, align 8
  %__p.addr = alloca %"struct.std::pair"*, align 8
  store %"class.__gnu_cxx::new_allocator.19"* %this, %"class.__gnu_cxx::new_allocator.19"** %this.addr, align 8
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local void @_ZNSt5tupleIJOjEEC2IJjELb1EEEDpOT_(%"class.std::tuple"* nonnull dereferenceable(8) %this, i32* nonnull align 4 dereferenceable(4) %__elements) unnamed_addr #6 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::tuple"*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt11_Tuple_implILm0EJOjEEC2IjEEOT_(%"struct.std::_Tuple_impl"* nonnull dereferenceable(8) %this, i32* nonnull align 4 dereferenceable(4) %__head) unnamed_addr #8 comdat align 2 {
entry:
  %this.addr = alloca %"struct.std::_Tuple_impl"*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt8_Rb_treeIjSt4pairIKjPvESt10_Select1stIS3_ESt4lessIjESaIS3_EED2Ev(%"class.std::_Rb_tree.17"* nonnull dereferenceable(48) %this) unnamed_addr #8 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
  %this.addr = alloca %"class.std::_Rb_tree.17"*, align 8
  %exn.slot = alloca i8*, align 8
  %ehselector.slot = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSaISt13_Rb_tree_nodeISt4pairIKjPvEEED2Ev(%"class.std::allocator.18"* nonnull dereferenceable(1) %this) unnamed_addr #8 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::allocator.18"*, align 8
  store %"class.std::allocator.18"* %this, %"class.std::allocator.18"** %this.addr, align 8
  %this1 = load %"class.std::allocator.18"*, %"class.std::allocator.18"** %this.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZN9__gnu_cxx13new_allocatorISt13_Rb_tree_nodeISt4pairIKjPvEEED2Ev(%"class.__gnu_cxx::new_allocator.19"* nonnull dereferenceable(1) %this) unnamed_addr #8 comdat align 2 {
entry:
  %this.addr = alloca %"class.__gnu_cxx::new_allocator.19"*, align 8
  store %"class.__gnu_cxx::new_allocator.19"* %this, %"class.__gnu_cxx::new_allocator.19"** %this.addr, align 8
  %this1 = load %"class.__gnu_cxx::new_allocator.19"*, %"class.__gnu_cxx::new_allocator.19"** %this.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt12__mutex_baseC2Ev(%"class.std::__mutex_base"* nonnull dereferenceable(40) %this) unnamed_addr #8 comdat align 2 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt8_Rb_treeINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_PvESt10_Select1stIS9_ESt4lessIS5_ESaIS9_EED2Ev(%"class.std::_Rb_tree.9"* nonnull dereferenceable(48) %this) unnamed_addr #8 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
  %this.addr = alloca %"class.std::_Rb_tree.9"*, align 8
  %exn.slot = alloca i8*, align 8
  %ehselector.slot = alloca i32, align 4
  store %"class.std::_Rb_tree.9"* %this, %"class.std::_Rb_tree.9"** %this.addr, align 8
  %this1 = load %"class.std::_Rb_tree.9"*, %"class.std::_Rb_tree.9"** %this.addr, align 8
  %call = call %"struct.std::_Rb_tree_node.36"* @_ZNSt8_Rb_treeINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_PvESt10_Select1stIS9_ESt4lessIS5_ESaIS9_EE8_M_beginEv(%"class.std::_Rb_tree.9"* nonnull dereferenceable(48) %this1) #3
  invoke void @_ZNSt8_Rb_treeINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_PvESt10_Select1stIS9_ESt4lessIS5_ESaIS9_EE8_M_eraseEPSt13_Rb_tree_nodeIS9_E(%"class.std::_Rb_tree.9"* nonnull dereferenceable(48) %this1, %"struct.std::_Rb_tree_node.36"* %call)
          to label %invoke.cont unwind label %lpad
...
; Function Attrs: noinline optnone uwtable mustprogress
define linkonce_odr dso_local void @_ZNSt8_Rb_treeINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_PvESt10_Select1stIS9_ESt4lessIS5_ESaIS9_EE8_M_eraseEPSt13_Rb_tree_nodeIS9_E(%"class.std::_Rb_tree.9"* nonnull dereferenceable(48) %this, %"struct.std::_Rb_tree_node.36"* %__x) #4 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::_Rb_tree.9"*, align 8
  %__x.addr = alloca %"struct.std::_Rb_tree_node.36"*, align 8
  %__y = alloca %"struct.std::_Rb_tree_node.36"*, align 8
  store %"class.std::_Rb_tree.9"* %this, %"class.std::_Rb_tree.9"** %this.addr, align 8
  store %"struct.std::_Rb_tree_node.36"* %__x, %"struct.std::_Rb_tree_node.36"** %__x.addr, align 8
  %this1 = load %"class.std::_Rb_tree.9"*, %"class.std::_Rb_tree.9"** %this.addr, align 8
  br label %while.cond

while.cond:                                       ; preds = %while.body, %entry
  %0 = load %"struct.std::_Rb_tree_node.36"*, %"struct.std::_Rb_tree_node.36"** %__x.addr, align 8
  %cmp = icmp ne %"struct.std::_Rb_tree_node.36"* %0, null
  br i1 %cmp, label %while.body, label %while.end

while.body:                                       ; preds = %while.cond
  %1 = load %"struct.std::_Rb_tree_node.36"*, %"struct.std::_Rb_tree_node.36"** %__x.addr, align 8
  %2 = bitcast %"struct.std::_Rb_tree_node.36"* %1 to %"struct.std::_Rb_tree_node_base"*
  %call = call %"struct.std::_Rb_tree_node.36"* @_ZNSt8_Rb_treeINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_PvESt10_Select1stIS9_ESt4lessIS5_ESaIS9_EE8_S_rightEPSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_node_base"* %2) #3
  call void @_ZNSt8_Rb_treeINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_PvESt10_Select1stIS9_ESt4lessIS5_ESaIS9_EE8_M_eraseEPSt13_Rb_tree_nodeIS9_E(%"class.std::_Rb_tree.9"* nonnull dereferenceable(48) %this1, %"struct.std::_Rb_tree_node.36"* %call)
  %3 = load %"struct.std::_Rb_tree_node.36"*, %"struct.std::_Rb_tree_node.36"** %__x.addr, align 8
  %4 = bitcast %"struct.std::_Rb_tree_node.36"* %3 to %"struct.std::_Rb_tree_node_base"*
  %call2 = call %"struct.std::_Rb_tree_node.36"* @_ZNSt8_Rb_treeINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_PvESt10_Select1stIS9_ESt4lessIS5_ESaIS9_EE7_S_leftEPSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_node_base"* %4) #3
  store %"struct.std::_Rb_tree_node.36"* %call2, %"struct.std::_Rb_tree_node.36"** %__y, align 8
  %5 = load %"struct.std::_Rb_tree_node.36"*, %"struct.std::_Rb_tree_node.36"** %__x.addr, align 8
  call void @_ZNSt8_Rb_treeINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_PvESt10_Select1stIS9_ESt4lessIS5_ESaIS9_EE12_M_drop_nodeEPSt13_Rb_tree_nodeIS9_E(%"class.std::_Rb_tree.9"* nonnull dereferenceable(48) %this1, %"struct.std::_Rb_tree_node.36"* %5) #3
  %6 = load %"struct.std::_Rb_tree_node.36"*, %"struct.std::_Rb_tree_node.36"** %__y, align 8
  store %"struct.std::_Rb_tree_node.36"* %6, %"struct.std::_Rb_tree_node.36"** %__x.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local %"struct.std::_Rb_tree_node.36"* @_ZNSt8_Rb_treeINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_PvESt10_Select1stIS9_ESt4lessIS5_ESaIS9_EE8_M_beginEv(%"class.std::_Rb_tree.9"* nonnull dereferenceable(48) %this) #9 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::_Rb_tree.9"*, align 8
  store %"class.std::_Rb_tree.9"* %this, %"class.std::_Rb_tree.9"** %this.addr, align 8
  %this1 = load %"class.std::_Rb_tree.9"*, %"class.std::_Rb_tree.9"** %this.addr, align 8
  ...
  %_M_parent = getelementptr inbounds %"struct.std::_Rb_tree_node_base", %"struct.std::_Rb_tree_node_base"* %_M_header, i32 0, i32 1
  %2 = load %"struct.std::_Rb_tree_node_base"*, %"struct.std::_Rb_tree_node_base"** %_M_parent, align 8
  %3 = bitcast %"struct.std::_Rb_tree_node_base"* %2 to %"struct.std::_Rb_tree_node.36"*
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local %"struct.std::_Rb_tree_node.36"* @_ZNSt8_Rb_treeINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_PvESt10_Select1stIS9_ESt4lessIS5_ESaIS9_EE8_S_rightEPSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_node_base"* %__x) #9 comdat align 2 {
entry:
  %__x.addr = alloca %"struct.std::_Rb_tree_node_base"*, align 8
  store %"struct.std::_Rb_tree_node_base"* %__x, %"struct.std::_Rb_tree_node_base"** %__x.addr, align 8
  %0 = load %"struct.std::_Rb_tree_node_base"*, %"struct.std::_Rb_tree_node_base"** %__x.addr, align 8
  %_M_right = getelementptr inbounds %"struct.std::_Rb_tree_node_base", %"struct.std::_Rb_tree_node_base"* %0, i32 0, i32 3
  %1 = load %"struct.std::_Rb_tree_node_base"*, %"struct.std::_Rb_tree_node_base"** %_M_right, align 8
  %2 = bitcast %"struct.std::_Rb_tree_node_base"* %1 to %"struct.std::_Rb_tree_node.36"*
  ret %"struct.std::_Rb_tree_node.36"* %2
}

; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local %"struct.std::_Rb_tree_node.36"* @_ZNSt8_Rb_treeINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_PvESt10_Select1stIS9_ESt4lessIS5_ESaIS9_EE7_S_leftEPSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_node_base"* %__x) #9 comdat align 2 {
entry:
  %__x.addr = alloca %"struct.std::_Rb_tree_node_base"*, align 8
  store %"struct.std::_Rb_tree_node_base"* %__x, %"struct.std::_Rb_tree_node_base"** %__x.addr, align 8
  %0 = load %"struct.std::_Rb_tree_node_base"*, %"struct.std::_Rb_tree_node_base"** %__x.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local void @_ZNSt8_Rb_treeINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_PvESt10_Select1stIS9_ESt4lessIS5_ESaIS9_EE12_M_drop_nodeEPSt13_Rb_tree_nodeIS9_E(%"class.std::_Rb_tree.9"* nonnull dereferenceable(48) %this, %"struct.std::_Rb_tree_node.36"* %__p) #9 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::_Rb_tree.9"*, align 8
  %__p.addr = alloca %"struct.std::_Rb_tree_node.36"*, align 8
  store %"class.std::_Rb_tree.9"* %this, %"class.std::_Rb_tree.9"** %this.addr, align 8
  store %"struct.std::_Rb_tree_node.36"* %__p, %"struct.std::_Rb_tree_node.36"** %__p.addr, align 8
  %this1 = load %"class.std::_Rb_tree.9"*, %"class.std::_Rb_tree.9"** %this.addr, align 8
  %0 = load %"struct.std::_Rb_tree_node.36"*, %"struct.std::_Rb_tree_node.36"** %__p.addr, align 8
  call void @_ZNSt8_Rb_treeINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_PvESt10_Select1stIS9_ESt4lessIS5_ESaIS9_EE15_M_destroy_nodeEPSt13_Rb_tree_nodeIS9_E(%"class.std::_Rb_tree.9"* nonnull dereferenceable(48) %this1, %"struct.std::_Rb_tree_node.36"* %0) #3
  %1 = load %"struct.std::_Rb_tree_node.36"*, %"struct.std::_Rb_tree_node.36"** %__p.addr, align 8
  call void @_ZNSt8_Rb_treeINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_PvESt10_Select1stIS9_ESt4lessIS5_ESaIS9_EE11_M_put_nodeEPSt13_Rb_tree_nodeIS9_E(%"class.std::_Rb_tree.9"* nonnull dereferenceable(48) %this1, %"struct.std::_Rb_tree_node.36"* %1) #3
  ret void
}

; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local void @_ZNSt8_Rb_treeINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_PvESt10_Select1stIS9_ESt4lessIS5_ESaIS9_EE15_M_destroy_nodeEPSt13_Rb_tree_nodeIS9_E(%"class.std::_Rb_tree.9"* nonnull dereferenceable(48) %this, %"struct.std::_Rb_tree_node.36"* %__p) #9 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
  %this.addr = alloca %"class.std::_Rb_tree.9"*, align 8
  %__p.addr = alloca %"struct.std::_Rb_tree_node.36"*, align 8
  store %"class.std::_Rb_tree.9"* %this, %"class.std::_Rb_tree.9"** %this.addr, align 8
  ...
  %0 = load %"struct.std::_Rb_tree_node.36"*, %"struct.std::_Rb_tree_node.36"** %__p.addr, align 8
  %call2 = invoke %"struct.std::pair.38"* @_ZNSt13_Rb_tree_nodeISt4pairIKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEPvEE9_M_valptrEv(%"struct.std::_Rb_tree_node.36"* nonnull dereferenceable(72) %0)
          to label %invoke.cont unwind label %terminate.lpad

invoke.cont:                                      ; preds = %entry
  call void @_ZNSt16allocator_traitsISaISt13_Rb_tree_nodeISt4pairIKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEPvEEEE7destroyISA_EEvRSC_PT_(%"class.std::allocator.10"* nonnull align 1 dereferenceable(1) %call, %"struct.std::pair.38"* %call2) #3
  %1 = load %"struct.std::_Rb_tree_node.36"*, %"struct.std::_Rb_tree_node.36"** %__p.addr, align 8
  ret void
...
entry:
  ...
  %call = call nonnull align 1 dereferenceable(1) %"class.std::allocator.10"* @_ZNSt8_Rb_treeINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_PvESt10_Select1stIS9_ESt4lessIS5_ESaIS9_EE21_M_get_Node_allocatorEv(%"class.std::_Rb_tree.9"* nonnull dereferenceable(48) %this1) #3
  %0 = load %"struct.std::_Rb_tree_node.36"*, %"struct.std::_Rb_tree_node.36"** %__p.addr, align 8
  invoke void @_ZNSt16allocator_traitsISaISt13_Rb_tree_nodeISt4pairIKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEPvEEEE10deallocateERSC_PSB_m(%"class.std::allocator.10"* nonnull align 1 dereferenceable(1) %call, %"struct.std::_Rb_tree_node.36"* %0, i64 1)
          to label %invoke.cont unwind label %terminate.lpad
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local void @_ZNSt16allocator_traitsISaISt13_Rb_tree_nodeISt4pairIKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEPvEEEE7destroyISA_EEvRSC_PT_(%"class.std::allocator.10"* nonnull align 1 dereferenceable(1) %__a, %"struct.std::pair.38"* %__p) #9 comdat align 2 {
entry:
  %__a.addr = alloca %"class.std::allocator.10"*, align 8
  %__p.addr = alloca %"struct.std::pair.38"*, align 8
  store %"class.std::allocator.10"* %__a, %"class.std::allocator.10"** %__a.addr, align 8
  store %"struct.std::pair.38"* %__p, %"struct.std::pair.38"** %__p.addr, align 8
  ...
  %2 = load %"struct.std::pair.38"*, %"struct.std::pair.38"** %__p.addr, align 8
  call void @_ZN9__gnu_cxx13new_allocatorISt13_Rb_tree_nodeISt4pairIKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEPvEEE7destroyISB_EEvPT_(%"class.__gnu_cxx::new_allocator.11"* nonnull dereferenceable(1) %1, %"struct.std::pair.38"* %2) #3
  ret void
}

; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local nonnull align 1 dereferenceable(1) %"class.std::allocator.10"* @_ZNSt8_Rb_treeINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_PvESt10_Select1stIS9_ESt4lessIS5_ESaIS9_EE21_M_get_Node_allocatorEv(%"class.std::_Rb_tree.9"* nonnull dereferenceable(48) %this) #9 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::_Rb_tree.9"*, align 8
  store %"class.std::_Rb_tree.9"* %this, %"class.std::_Rb_tree.9"** %this.addr, align 8
  %this1 = load %"class.std::_Rb_tree.9"*, %"class.std::_Rb_tree.9"** %this.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local %"struct.std::pair.38"* @_ZNSt13_Rb_tree_nodeISt4pairIKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEPvEE9_M_valptrEv(%"struct.std::_Rb_tree_node.36"* nonnull dereferenceable(72) %this) #9 comdat align 2 {
entry:
  %this.addr = alloca %"struct.std::_Rb_tree_node.36"*, align 8
  store %"struct.std::_Rb_tree_node.36"* %this, %"struct.std::_Rb_tree_node.36"** %this.addr, align 8
  %this1 = load %"struct.std::_Rb_tree_node.36"*, %"struct.std::_Rb_tree_node.36"** %this.addr, align 8
  %_M_storage = getelementptr inbounds %"struct.std::_Rb_tree_node.36", %"struct.std::_Rb_tree_node.36"* %this1, i32 0, i32 1
  %call = call %"struct.std::pair.38"* @_ZN9__gnu_cxx16__aligned_membufISt4pairIKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEPvEE6_M_ptrEv(%"struct.__gnu_cxx::__aligned_membuf.37"* nonnull dereferenceable(40) %_M_storage) #3
  ret %"struct.std::pair.38"* %call
}

; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local void @_ZN9__gnu_cxx13new_allocatorISt13_Rb_tree_nodeISt4pairIKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEPvEEE7destroyISB_EEvPT_(%"class.__gnu_cxx::new_allocator.11"* nonnull dereferenceable(1) %this, %"struct.std::pair.38"* %__p) #9 comdat align 2 {
entry:
  %this.addr = alloca %"class.__gnu_cxx::new_allocator.11"*, align 8
  %__p.addr = alloca %"struct.std::pair.38"*, align 8
  store %"class.__gnu_cxx::new_allocator.11"* %this, %"class.__gnu_cxx::new_allocator.11"** %this.addr, align 8
  store %"struct.std::pair.38"* %__p, %"struct.std::pair.38"** %__p.addr, align 8
  %this1 = load %"class.__gnu_cxx::new_allocator.11"*, %"class.__gnu_cxx::new_allocator.11"** %this.addr, align 8
  %0 = load %"struct.std::pair.38"*, %"struct.std::pair.38"** %__p.addr, align 8
  call void @_ZNSt4pairIKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEPvED2Ev(%"struct.std::pair.38"* nonnull dereferenceable(40) %0) #3
  ret void
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt4pairIKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEPvED2Ev(%"struct.std::pair.38"* nonnull dereferenceable(40) %this) unnamed_addr #8 comdat align 2 {
entry:
  %this.addr = alloca %"struct.std::pair.38"*, align 8
  store %"struct.std::pair.38"* %this, %"struct.std::pair.38"** %this.addr, align 8
  %this1 = load %"struct.std::pair.38"*, %"struct.std::pair.38"** %this.addr, align 8
  %first = getelementptr inbounds %"struct.std::pair.38", %"struct.std::pair.38"* %this1, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local %"struct.std::pair.38"* @_ZN9__gnu_cxx16__aligned_membufISt4pairIKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEPvEE6_M_ptrEv(%"struct.__gnu_cxx::__aligned_membuf.37"* nonnull dereferenceable(40) %this) #9 comdat align 2 {
entry:
  %this.addr = alloca %"struct.__gnu_cxx::__aligned_membuf.37"*, align 8
  store %"struct.__gnu_cxx::__aligned_membuf.37"* %this, %"struct.__gnu_cxx::__aligned_membuf.37"** %this.addr, align 8
  %this1 = load %"struct.__gnu_cxx::__aligned_membuf.37"*, %"struct.__gnu_cxx::__aligned_membuf.37"** %this.addr, align 8
  %call = call i8* @_ZN9__gnu_cxx16__aligned_membufISt4pairIKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEPvEE7_M_addrEv(%"struct.__gnu_cxx::__aligned_membuf.37"* nonnull dereferenceable(40) %this1) #3
  %0 = bitcast i8* %call to %"struct.std::pair.38"*
  ret %"struct.std::pair.38"* %0
}

; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local i8* @_ZN9__gnu_cxx16__aligned_membufISt4pairIKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEPvEE7_M_addrEv(%"struct.__gnu_cxx::__aligned_membuf.37"* nonnull dereferenceable(40) %this) #9 comdat align 2 {
entry:
  %this.addr = alloca %"struct.__gnu_cxx::__aligned_membuf.37"*, align 8
  store %"struct.__gnu_cxx::__aligned_membuf.37"* %this, %"struct.__gnu_cxx::__aligned_membuf.37"** %this.addr, align 8
  %this1 = load %"struct.__gnu_cxx::__aligned_membuf.37"*, %"struct.__gnu_cxx::__aligned_membuf.37"** %this.addr, align 8
  %_M_storage = getelementptr inbounds %"struct.__gnu_cxx::__aligned_membuf.37", %"struct.__gnu_cxx::__aligned_membuf.37"* %this1, i32 0, i32 0
  %0 = bitcast [40 x i8]* %_M_storage to i8*
  ret i8* %0
}

; Function Attrs: noinline optnone uwtable mustprogress
define linkonce_odr dso_local void @_ZNSt16allocator_traitsISaISt13_Rb_tree_nodeISt4pairIKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEPvEEEE10deallocateERSC_PSB_m(%"class.std::allocator.10"* nonnull align 1 dereferenceable(1) %__a, %"struct.std::_Rb_tree_node.36"* %__p, i64 %__n) #4 comdat align 2 {
entry:
  %__a.addr = alloca %"class.std::allocator.10"*, align 8
  %__p.addr = alloca %"struct.std::_Rb_tree_node.36"*, align 8
  %__n.addr = alloca i64, align 8
  ...
  %0 = load %"class.std::allocator.10"*, %"class.std::allocator.10"** %__a.addr, align 8
  %1 = bitcast %"class.std::allocator.10"* %0 to %"class.__gnu_cxx::new_allocator.11"*
  %2 = load %"struct.std::_Rb_tree_node.36"*, %"struct.std::_Rb_tree_node.36"** %__p.addr, align 8
  %3 = load i64, i64* %__n.addr, align 8
  call void @_ZN9__gnu_cxx13new_allocatorISt13_Rb_tree_nodeISt4pairIKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEPvEEE10deallocateEPSC_m(%"class.__gnu_cxx::new_allocator.11"* nonnull dereferenceable(1) %1, %"struct.std::_Rb_tree_node.36"* %2, i64 %3)
  ret void
}

; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local void @_ZN9__gnu_cxx13new_allocatorISt13_Rb_tree_nodeISt4pairIKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEPvEEE10deallocateEPSC_m(%"class.__gnu_cxx::new_allocator.11"* nonnull dereferenceable(1) %this, %"struct.std::_Rb_tree_node.36"* %__p, i64 %0) #9 comdat align 2 {
entry:
  %this.addr = alloca %"class.__gnu_cxx::new_allocator.11"*, align 8
  %__p.addr = alloca %"struct.std::_Rb_tree_node.36"*, align 8
  %.addr = alloca i64, align 8
  ...
  %this1 = load %"class.__gnu_cxx::new_allocator.11"*, %"class.__gnu_cxx::new_allocator.11"** %this.addr, align 8
  %1 = load %"struct.std::_Rb_tree_node.36"*, %"struct.std::_Rb_tree_node.36"** %__p.addr, align 8
  %2 = bitcast %"struct.std::_Rb_tree_node.36"* %1 to i8*
  call void @_ZdlPv(i8* %2) #3
  ret void
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSaISt13_Rb_tree_nodeISt4pairIKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEPvEEED2Ev(%"class.std::allocator.10"* nonnull dereferenceable(1) %this) unnamed_addr #8 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::allocator.10"*, align 8
  store %"class.std::allocator.10"* %this, %"class.std::allocator.10"** %this.addr, align 8
  %this1 = load %"class.std::allocator.10"*, %"class.std::allocator.10"** %this.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZN9__gnu_cxx13new_allocatorISt13_Rb_tree_nodeISt4pairIKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEPvEEED2Ev(%"class.__gnu_cxx::new_allocator.11"* nonnull dereferenceable(1) %this) unnamed_addr #8 comdat align 2 {
entry:
  %this.addr = alloca %"class.__gnu_cxx::new_allocator.11"*, align 8
  store %"class.__gnu_cxx::new_allocator.11"* %this, %"class.__gnu_cxx::new_allocator.11"** %this.addr, align 8
  %this1 = load %"class.__gnu_cxx::new_allocator.11"*, %"class.__gnu_cxx::new_allocator.11"** %this.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt3mapIjPKvSt4lessIjESaISt4pairIKjS1_EEED2Ev(%"class.std::map.0"* nonnull dereferenceable(48) %this) unnamed_addr #8 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::map.0"*, align 8
  store %"class.std::map.0"* %this, %"class.std::map.0"** %this.addr, align 8
  %this1 = load %"class.std::map.0"*, %"class.std::map.0"** %this.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt3mapIPKvjSt4lessIS1_ESaISt4pairIKS1_jEEED2Ev(%"class.std::map"* nonnull dereferenceable(48) %this) unnamed_addr #8 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::map"*, align 8
  store %"class.std::map"* %this, %"class.std::map"** %this.addr, align 8
  %this1 = load %"class.std::map"*, %"class.std::map"** %this.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt8_Rb_treeIjSt4pairIKjPKvESt10_Select1stIS4_ESt4lessIjESaIS4_EED2Ev(%"class.std::_Rb_tree.1"* nonnull dereferenceable(48) %this) unnamed_addr #8 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
  %this.addr = alloca %"class.std::_Rb_tree.1"*, align 8
  %exn.slot = alloca i8*, align 8
  %ehselector.slot = alloca i32, align 4
  store %"class.std::_Rb_tree.1"* %this, %"class.std::_Rb_tree.1"** %this.addr, align 8
  %this1 = load %"class.std::_Rb_tree.1"*, %"class.std::_Rb_tree.1"** %this.addr, align 8
  %call = call %"struct.std::_Rb_tree_node.44"* @_ZNSt8_Rb_treeIjSt4pairIKjPKvESt10_Select1stIS4_ESt4lessIjESaIS4_EE8_M_beginEv(%"class.std::_Rb_tree.1"* nonnull dereferenceable(48) %this1) #3
  invoke void @_ZNSt8_Rb_treeIjSt4pairIKjPKvESt10_Select1stIS4_ESt4lessIjESaIS4_EE8_M_eraseEPSt13_Rb_tree_nodeIS4_E(%"class.std::_Rb_tree.1"* nonnull dereferenceable(48) %this1, %"struct.std::_Rb_tree_node.44"* %call)
          to label %invoke.cont unwind label %lpad
...
; Function Attrs: noinline optnone uwtable mustprogress
define linkonce_odr dso_local void @_ZNSt8_Rb_treeIjSt4pairIKjPKvESt10_Select1stIS4_ESt4lessIjESaIS4_EE8_M_eraseEPSt13_Rb_tree_nodeIS4_E(%"class.std::_Rb_tree.1"* nonnull dereferenceable(48) %this, %"struct.std::_Rb_tree_node.44"* %__x) #4 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::_Rb_tree.1"*, align 8
  %__x.addr = alloca %"struct.std::_Rb_tree_node.44"*, align 8
  %__y = alloca %"struct.std::_Rb_tree_node.44"*, align 8
  store %"class.std::_Rb_tree.1"* %this, %"class.std::_Rb_tree.1"** %this.addr, align 8
  store %"struct.std::_Rb_tree_node.44"* %__x, %"struct.std::_Rb_tree_node.44"** %__x.addr, align 8
  %this1 = load %"class.std::_Rb_tree.1"*, %"class.std::_Rb_tree.1"** %this.addr, align 8
  br label %while.cond

while.cond:                                       ; preds = %while.body, %entry
  %0 = load %"struct.std::_Rb_tree_node.44"*, %"struct.std::_Rb_tree_node.44"** %__x.addr, align 8
  %cmp = icmp ne %"struct.std::_Rb_tree_node.44"* %0, null
  br i1 %cmp, label %while.body, label %while.end

while.body:                                       ; preds = %while.cond
  %1 = load %"struct.std::_Rb_tree_node.44"*, %"struct.std::_Rb_tree_node.44"** %__x.addr, align 8
  %2 = bitcast %"struct.std::_Rb_tree_node.44"* %1 to %"struct.std::_Rb_tree_node_base"*
  %call = call %"struct.std::_Rb_tree_node.44"* @_ZNSt8_Rb_treeIjSt4pairIKjPKvESt10_Select1stIS4_ESt4lessIjESaIS4_EE8_S_rightEPSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_node_base"* %2) #3
  call void @_ZNSt8_Rb_treeIjSt4pairIKjPKvESt10_Select1stIS4_ESt4lessIjESaIS4_EE8_M_eraseEPSt13_Rb_tree_nodeIS4_E(%"class.std::_Rb_tree.1"* nonnull dereferenceable(48) %this1, %"struct.std::_Rb_tree_node.44"* %call)
  %3 = load %"struct.std::_Rb_tree_node.44"*, %"struct.std::_Rb_tree_node.44"** %__x.addr, align 8
  %4 = bitcast %"struct.std::_Rb_tree_node.44"* %3 to %"struct.std::_Rb_tree_node_base"*
  %call2 = call %"struct.std::_Rb_tree_node.44"* @_ZNSt8_Rb_treeIjSt4pairIKjPKvESt10_Select1stIS4_ESt4lessIjESaIS4_EE7_S_leftEPSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_node_base"* %4) #3
  store %"struct.std::_Rb_tree_node.44"* %call2, %"struct.std::_Rb_tree_node.44"** %__y, align 8
  %5 = load %"struct.std::_Rb_tree_node.44"*, %"struct.std::_Rb_tree_node.44"** %__x.addr, align 8
  call void @_ZNSt8_Rb_treeIjSt4pairIKjPKvESt10_Select1stIS4_ESt4lessIjESaIS4_EE12_M_drop_nodeEPSt13_Rb_tree_nodeIS4_E(%"class.std::_Rb_tree.1"* nonnull dereferenceable(48) %this1, %"struct.std::_Rb_tree_node.44"* %5) #3
  %6 = load %"struct.std::_Rb_tree_node.44"*, %"struct.std::_Rb_tree_node.44"** %__y, align 8
  store %"struct.std::_Rb_tree_node.44"* %6, %"struct.std::_Rb_tree_node.44"** %__x.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local %"struct.std::_Rb_tree_node.44"* @_ZNSt8_Rb_treeIjSt4pairIKjPKvESt10_Select1stIS4_ESt4lessIjESaIS4_EE8_M_beginEv(%"class.std::_Rb_tree.1"* nonnull dereferenceable(48) %this) #9 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::_Rb_tree.1"*, align 8
  store %"class.std::_Rb_tree.1"* %this, %"class.std::_Rb_tree.1"** %this.addr, align 8
  %this1 = load %"class.std::_Rb_tree.1"*, %"class.std::_Rb_tree.1"** %this.addr, align 8
  ...
  %_M_parent = getelementptr inbounds %"struct.std::_Rb_tree_node_base", %"struct.std::_Rb_tree_node_base"* %_M_header, i32 0, i32 1
  %2 = load %"struct.std::_Rb_tree_node_base"*, %"struct.std::_Rb_tree_node_base"** %_M_parent, align 8
  %3 = bitcast %"struct.std::_Rb_tree_node_base"* %2 to %"struct.std::_Rb_tree_node.44"*
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local %"struct.std::_Rb_tree_node.44"* @_ZNSt8_Rb_treeIjSt4pairIKjPKvESt10_Select1stIS4_ESt4lessIjESaIS4_EE8_S_rightEPSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_node_base"* %__x) #9 comdat align 2 {
entry:
  %__x.addr = alloca %"struct.std::_Rb_tree_node_base"*, align 8
  store %"struct.std::_Rb_tree_node_base"* %__x, %"struct.std::_Rb_tree_node_base"** %__x.addr, align 8
  %0 = load %"struct.std::_Rb_tree_node_base"*, %"struct.std::_Rb_tree_node_base"** %__x.addr, align 8
  %_M_right = getelementptr inbounds %"struct.std::_Rb_tree_node_base", %"struct.std::_Rb_tree_node_base"* %0, i32 0, i32 3
  %1 = load %"struct.std::_Rb_tree_node_base"*, %"struct.std::_Rb_tree_node_base"** %_M_right, align 8
  %2 = bitcast %"struct.std::_Rb_tree_node_base"* %1 to %"struct.std::_Rb_tree_node.44"*
  ret %"struct.std::_Rb_tree_node.44"* %2
}

; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local %"struct.std::_Rb_tree_node.44"* @_ZNSt8_Rb_treeIjSt4pairIKjPKvESt10_Select1stIS4_ESt4lessIjESaIS4_EE7_S_leftEPSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_node_base"* %__x) #9 comdat align 2 {
entry:
  %__x.addr = alloca %"struct.std::_Rb_tree_node_base"*, align 8
  store %"struct.std::_Rb_tree_node_base"* %__x, %"struct.std::_Rb_tree_node_base"** %__x.addr, align 8
  %0 = load %"struct.std::_Rb_tree_node_base"*, %"struct.std::_Rb_tree_node_base"** %__x.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local void @_ZNSt8_Rb_treeIjSt4pairIKjPKvESt10_Select1stIS4_ESt4lessIjESaIS4_EE12_M_drop_nodeEPSt13_Rb_tree_nodeIS4_E(%"class.std::_Rb_tree.1"* nonnull dereferenceable(48) %this, %"struct.std::_Rb_tree_node.44"* %__p) #9 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::_Rb_tree.1"*, align 8
  %__p.addr = alloca %"struct.std::_Rb_tree_node.44"*, align 8
  store %"class.std::_Rb_tree.1"* %this, %"class.std::_Rb_tree.1"** %this.addr, align 8
  store %"struct.std::_Rb_tree_node.44"* %__p, %"struct.std::_Rb_tree_node.44"** %__p.addr, align 8
  %this1 = load %"class.std::_Rb_tree.1"*, %"class.std::_Rb_tree.1"** %this.addr, align 8
  %0 = load %"struct.std::_Rb_tree_node.44"*, %"struct.std::_Rb_tree_node.44"** %__p.addr, align 8
  call void @_ZNSt8_Rb_treeIjSt4pairIKjPKvESt10_Select1stIS4_ESt4lessIjESaIS4_EE15_M_destroy_nodeEPSt13_Rb_tree_nodeIS4_E(%"class.std::_Rb_tree.1"* nonnull dereferenceable(48) %this1, %"struct.std::_Rb_tree_node.44"* %0) #3
  %1 = load %"struct.std::_Rb_tree_node.44"*, %"struct.std::_Rb_tree_node.44"** %__p.addr, align 8
  call void @_ZNSt8_Rb_treeIjSt4pairIKjPKvESt10_Select1stIS4_ESt4lessIjESaIS4_EE11_M_put_nodeEPSt13_Rb_tree_nodeIS4_E(%"class.std::_Rb_tree.1"* nonnull dereferenceable(48) %this1, %"struct.std::_Rb_tree_node.44"* %1) #3
  ret void
}

; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local void @_ZNSt8_Rb_treeIjSt4pairIKjPKvESt10_Select1stIS4_ESt4lessIjESaIS4_EE15_M_destroy_nodeEPSt13_Rb_tree_nodeIS4_E(%"class.std::_Rb_tree.1"* nonnull dereferenceable(48) %this, %"struct.std::_Rb_tree_node.44"* %__p) #9 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
  %this.addr = alloca %"class.std::_Rb_tree.1"*, align 8
  %__p.addr = alloca %"struct.std::_Rb_tree_node.44"*, align 8
  store %"class.std::_Rb_tree.1"* %this, %"class.std::_Rb_tree.1"** %this.addr, align 8
  ...
  %0 = load %"struct.std::_Rb_tree_node.44"*, %"struct.std::_Rb_tree_node.44"** %__p.addr, align 8
  %call2 = invoke %"struct.std::pair.46"* @_ZNSt13_Rb_tree_nodeISt4pairIKjPKvEE9_M_valptrEv(%"struct.std::_Rb_tree_node.44"* nonnull dereferenceable(48) %0)
          to label %invoke.cont unwind label %terminate.lpad

invoke.cont:                                      ; preds = %entry
  call void @_ZNSt16allocator_traitsISaISt13_Rb_tree_nodeISt4pairIKjPKvEEEE7destroyIS5_EEvRS7_PT_(%"class.std::allocator.2"* nonnull align 1 dereferenceable(1) %call, %"struct.std::pair.46"* %call2) #3
  %1 = load %"struct.std::_Rb_tree_node.44"*, %"struct.std::_Rb_tree_node.44"** %__p.addr, align 8
  ret void
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local void @_ZNSt8_Rb_treeIjSt4pairIKjPKvESt10_Select1stIS4_ESt4lessIjESaIS4_EE11_M_put_nodeEPSt13_Rb_tree_nodeIS4_E(%"class.std::_Rb_tree.1"* nonnull dereferenceable(48) %this, %"struct.std::_Rb_tree_node.44"* %__p) #9 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
  %this.addr = alloca %"class.std::_Rb_tree.1"*, align 8
  %__p.addr = alloca %"struct.std::_Rb_tree_node.44"*, align 8
  store %"class.std::_Rb_tree.1"* %this, %"class.std::_Rb_tree.1"** %this.addr, align 8
  ...
  %call = call nonnull align 1 dereferenceable(1) %"class.std::allocator.2"* @_ZNSt8_Rb_treeIjSt4pairIKjPKvESt10_Select1stIS4_ESt4lessIjESaIS4_EE21_M_get_Node_allocatorEv(%"class.std::_Rb_tree.1"* nonnull dereferenceable(48) %this1) #3
  %0 = load %"struct.std::_Rb_tree_node.44"*, %"struct.std::_Rb_tree_node.44"** %__p.addr, align 8
  invoke void @_ZNSt16allocator_traitsISaISt13_Rb_tree_nodeISt4pairIKjPKvEEEE10deallocateERS7_PS6_m(%"class.std::allocator.2"* nonnull align 1 dereferenceable(1) %call, %"struct.std::_Rb_tree_node.44"* %0, i64 1)
          to label %invoke.cont unwind label %terminate.lpad
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local void @_ZNSt16allocator_traitsISaISt13_Rb_tree_nodeISt4pairIKjPKvEEEE7destroyIS5_EEvRS7_PT_(%"class.std::allocator.2"* nonnull align 1 dereferenceable(1) %__a, %"struct.std::pair.46"* %__p) #9 comdat align 2 {
entry:
  %__a.addr = alloca %"class.std::allocator.2"*, align 8
  %__p.addr = alloca %"struct.std::pair.46"*, align 8
  store %"class.std::allocator.2"* %__a, %"class.std::allocator.2"** %__a.addr, align 8
  store %"struct.std::pair.46"* %__p, %"struct.std::pair.46"** %__p.addr, align 8
  ...
  %2 = load %"struct.std::pair.46"*, %"struct.std::pair.46"** %__p.addr, align 8
  call void @_ZN9__gnu_cxx13new_allocatorISt13_Rb_tree_nodeISt4pairIKjPKvEEE7destroyIS6_EEvPT_(%"class.__gnu_cxx::new_allocator.3"* nonnull dereferenceable(1) %1, %"struct.std::pair.46"* %2) #3
  ret void
}

; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local nonnull align 1 dereferenceable(1) %"class.std::allocator.2"* @_ZNSt8_Rb_treeIjSt4pairIKjPKvESt10_Select1stIS4_ESt4lessIjESaIS4_EE21_M_get_Node_allocatorEv(%"class.std::_Rb_tree.1"* nonnull dereferenceable(48) %this) #9 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::_Rb_tree.1"*, align 8
  store %"class.std::_Rb_tree.1"* %this, %"class.std::_Rb_tree.1"** %this.addr, align 8
  %this1 = load %"class.std::_Rb_tree.1"*, %"class.std::_Rb_tree.1"** %this.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local %"struct.std::pair.46"* @_ZNSt13_Rb_tree_nodeISt4pairIKjPKvEE9_M_valptrEv(%"struct.std::_Rb_tree_node.44"* nonnull dereferenceable(48) %this) #9 comdat align 2 {
entry:
  %this.addr = alloca %"struct.std::_Rb_tree_node.44"*, align 8
  store %"struct.std::_Rb_tree_node.44"* %this, %"struct.std::_Rb_tree_node.44"** %this.addr, align 8
  %this1 = load %"struct.std::_Rb_tree_node.44"*, %"struct.std::_Rb_tree_node.44"** %this.addr, align 8
  %_M_storage = getelementptr inbounds %"struct.std::_Rb_tree_node.44", %"struct.std::_Rb_tree_node.44"* %this1, i32 0, i32 1
  %call = call %"struct.std::pair.46"* @_ZN9__gnu_cxx16__aligned_membufISt4pairIKjPKvEE6_M_ptrEv(%"struct.__gnu_cxx::__aligned_membuf.45"* nonnull dereferenceable(16) %_M_storage) #3
  ret %"struct.std::pair.46"* %call
}

; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local void @_ZN9__gnu_cxx13new_allocatorISt13_Rb_tree_nodeISt4pairIKjPKvEEE7destroyIS6_EEvPT_(%"class.__gnu_cxx::new_allocator.3"* nonnull dereferenceable(1) %this, %"struct.std::pair.46"* %__p) #9 comdat align 2 {
entry:
  %this.addr = alloca %"class.__gnu_cxx::new_allocator.3"*, align 8
  %__p.addr = alloca %"struct.std::pair.46"*, align 8
  store %"class.__gnu_cxx::new_allocator.3"* %this, %"class.__gnu_cxx::new_allocator.3"** %this.addr, align 8
  store %"struct.std::pair.46"* %__p, %"struct.std::pair.46"** %__p.addr, align 8
  %this1 = load %"class.__gnu_cxx::new_allocator.3"*, %"class.__gnu_cxx::new_allocator.3"** %this.addr, align 8
  %0 = load %"struct.std::pair.46"*, %"struct.std::pair.46"** %__p.addr, align 8
  ret void
}

; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local %"struct.std::pair.46"* @_ZN9__gnu_cxx16__aligned_membufISt4pairIKjPKvEE6_M_ptrEv(%"struct.__gnu_cxx::__aligned_membuf.45"* nonnull dereferenceable(16) %this) #9 comdat align 2 {
entry:
  %this.addr = alloca %"struct.__gnu_cxx::__aligned_membuf.45"*, align 8
  store %"struct.__gnu_cxx::__aligned_membuf.45"* %this, %"struct.__gnu_cxx::__aligned_membuf.45"** %this.addr, align 8
  %this1 = load %"struct.__gnu_cxx::__aligned_membuf.45"*, %"struct.__gnu_cxx::__aligned_membuf.45"** %this.addr, align 8
  %call = call i8* @_ZN9__gnu_cxx16__aligned_membufISt4pairIKjPKvEE7_M_addrEv(%"struct.__gnu_cxx::__aligned_membuf.45"* nonnull dereferenceable(16) %this1) #3
  %0 = bitcast i8* %call to %"struct.std::pair.46"*
  ret %"struct.std::pair.46"* %0
}

; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local i8* @_ZN9__gnu_cxx16__aligned_membufISt4pairIKjPKvEE7_M_addrEv(%"struct.__gnu_cxx::__aligned_membuf.45"* nonnull dereferenceable(16) %this) #9 comdat align 2 {
entry:
  %this.addr = alloca %"struct.__gnu_cxx::__aligned_membuf.45"*, align 8
  store %"struct.__gnu_cxx::__aligned_membuf.45"* %this, %"struct.__gnu_cxx::__aligned_membuf.45"** %this.addr, align 8
  %this1 = load %"struct.__gnu_cxx::__aligned_membuf.45"*, %"struct.__gnu_cxx::__aligned_membuf.45"** %this.addr, align 8
  %_M_storage = getelementptr inbounds %"struct.__gnu_cxx::__aligned_membuf.45", %"struct.__gnu_cxx::__aligned_membuf.45"* %this1, i32 0, i32 0
  %0 = bitcast [16 x i8]* %_M_storage to i8*
  ret i8* %0
}

; Function Attrs: noinline optnone uwtable mustprogress
define linkonce_odr dso_local void @_ZNSt16allocator_traitsISaISt13_Rb_tree_nodeISt4pairIKjPKvEEEE10deallocateERS7_PS6_m(%"class.std::allocator.2"* nonnull align 1 dereferenceable(1) %__a, %"struct.std::_Rb_tree_node.44"* %__p, i64 %__n) #4 comdat align 2 {
entry:
  %__a.addr = alloca %"class.std::allocator.2"*, align 8
  %__p.addr = alloca %"struct.std::_Rb_tree_node.44"*, align 8
  %__n.addr = alloca i64, align 8
  ...
  %0 = load %"class.std::allocator.2"*, %"class.std::allocator.2"** %__a.addr, align 8
  %1 = bitcast %"class.std::allocator.2"* %0 to %"class.__gnu_cxx::new_allocator.3"*
  %2 = load %"struct.std::_Rb_tree_node.44"*, %"struct.std::_Rb_tree_node.44"** %__p.addr, align 8
  %3 = load i64, i64* %__n.addr, align 8
  call void @_ZN9__gnu_cxx13new_allocatorISt13_Rb_tree_nodeISt4pairIKjPKvEEE10deallocateEPS7_m(%"class.__gnu_cxx::new_allocator.3"* nonnull dereferenceable(1) %1, %"struct.std::_Rb_tree_node.44"* %2, i64 %3)
  ret void
}

; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local void @_ZN9__gnu_cxx13new_allocatorISt13_Rb_tree_nodeISt4pairIKjPKvEEE10deallocateEPS7_m(%"class.__gnu_cxx::new_allocator.3"* nonnull dereferenceable(1) %this, %"struct.std::_Rb_tree_node.44"* %__p, i64 %0) #9 comdat align 2 {
entry:
  %this.addr = alloca %"class.__gnu_cxx::new_allocator.3"*, align 8
  %__p.addr = alloca %"struct.std::_Rb_tree_node.44"*, align 8
  %.addr = alloca i64, align 8
  ...
  %this1 = load %"class.__gnu_cxx::new_allocator.3"*, %"class.__gnu_cxx::new_allocator.3"** %this.addr, align 8
  %1 = load %"struct.std::_Rb_tree_node.44"*, %"struct.std::_Rb_tree_node.44"** %__p.addr, align 8
  %2 = bitcast %"struct.std::_Rb_tree_node.44"* %1 to i8*
  call void @_ZdlPv(i8* %2) #3
  ret void
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSaISt13_Rb_tree_nodeISt4pairIKjPKvEEED2Ev(%"class.std::allocator.2"* nonnull dereferenceable(1) %this) unnamed_addr #8 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::allocator.2"*, align 8
  store %"class.std::allocator.2"* %this, %"class.std::allocator.2"** %this.addr, align 8
  %this1 = load %"class.std::allocator.2"*, %"class.std::allocator.2"** %this.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZN9__gnu_cxx13new_allocatorISt13_Rb_tree_nodeISt4pairIKjPKvEEED2Ev(%"class.__gnu_cxx::new_allocator.3"* nonnull dereferenceable(1) %this) unnamed_addr #8 comdat align 2 {
entry:
  %this.addr = alloca %"class.__gnu_cxx::new_allocator.3"*, align 8
  store %"class.__gnu_cxx::new_allocator.3"* %this, %"class.__gnu_cxx::new_allocator.3"** %this.addr, align 8
  %this1 = load %"class.__gnu_cxx::new_allocator.3"*, %"class.__gnu_cxx::new_allocator.3"** %this.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt8_Rb_treeIPKvSt4pairIKS1_jESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EED2Ev(%"class.std::_Rb_tree"* nonnull dereferenceable(48) %this) unnamed_addr #8 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
  %this.addr = alloca %"class.std::_Rb_tree"*, align 8
  %exn.slot = alloca i8*, align 8
  %ehselector.slot = alloca i32, align 4
  store %"class.std::_Rb_tree"* %this, %"class.std::_Rb_tree"** %this.addr, align 8
  %this1 = load %"class.std::_Rb_tree"*, %"class.std::_Rb_tree"** %this.addr, align 8
  %call = call %"struct.std::_Rb_tree_node.49"* @_ZNSt8_Rb_treeIPKvSt4pairIKS1_jESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE8_M_beginEv(%"class.std::_Rb_tree"* nonnull dereferenceable(48) %this1) #3
  invoke void @_ZNSt8_Rb_treeIPKvSt4pairIKS1_jESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE8_M_eraseEPSt13_Rb_tree_nodeIS4_E(%"class.std::_Rb_tree"* nonnull dereferenceable(48) %this1, %"struct.std::_Rb_tree_node.49"* %call)
          to label %invoke.cont unwind label %lpad
...
; Function Attrs: noinline optnone uwtable mustprogress
define linkonce_odr dso_local void @_ZNSt8_Rb_treeIPKvSt4pairIKS1_jESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE8_M_eraseEPSt13_Rb_tree_nodeIS4_E(%"class.std::_Rb_tree"* nonnull dereferenceable(48) %this, %"struct.std::_Rb_tree_node.49"* %__x) #4 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::_Rb_tree"*, align 8
...
while.body:                                       ; preds = %while.cond
  ...
  %call = call %"struct.std::_Rb_tree_node.49"* @_ZNSt8_Rb_treeIPKvSt4pairIKS1_jESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE8_S_rightEPSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_node_base"* %2) #3
  call void @_ZNSt8_Rb_treeIPKvSt4pairIKS1_jESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE8_M_eraseEPSt13_Rb_tree_nodeIS4_E(%"class.std::_Rb_tree"* nonnull dereferenceable(48) %this1, %"struct.std::_Rb_tree_node.49"* %call)
  ...
  %call2 = call %"struct.std::_Rb_tree_node.49"* @_ZNSt8_Rb_treeIPKvSt4pairIKS1_jESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE7_S_leftEPSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_node_base"* %4) #3
  ...
  call void @_ZNSt8_Rb_treeIPKvSt4pairIKS1_jESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE12_M_drop_nodeEPSt13_Rb_tree_nodeIS4_E(%"class.std::_Rb_tree"* nonnull dereferenceable(48) %this1, %"struct.std::_Rb_tree_node.49"* %5) #3
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local %"struct.std::_Rb_tree_node.49"* @_ZNSt8_Rb_treeIPKvSt4pairIKS1_jESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE8_M_beginEv(%"class.std::_Rb_tree"* nonnull dereferenceable(48) %this) #9 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::_Rb_tree"*, align 8
  store %"class.std::_Rb_tree"* %this, %"class.std::_Rb_tree"** %this.addr, align 8
  %this1 = load %"class.std::_Rb_tree"*, %"class.std::_Rb_tree"** %this.addr, align 8
...
; Function Attrs: noinline nounwind optnone tainted uwtable mustprogress
define linkonce_odr dso_local %"struct.std::_Rb_tree_node.49"* @_ZNSt8_Rb_treeIPKvSt4pairIKS1_jESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE8_S_rightEPSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_node_base"* %__x) #17 comdat align 2 {
entry:
  %__x.addr = alloca %"struct.std::_Rb_tree_node_base"*, align 8
  store %"struct.std::_Rb_tree_node_base"* %__x, %"struct.std::_Rb_tree_node_base"** %__x.addr, align 8
  %0 = load %"struct.std::_Rb_tree_node_base"*, %"struct.std::_Rb_tree_node_base"** %__x.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local %"struct.std::_Rb_tree_node.49"* @_ZNSt8_Rb_treeIPKvSt4pairIKS1_jESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE7_S_leftEPSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_node_base"* %__x) #9 comdat align 2 {
entry:
  %__x.addr = alloca %"struct.std::_Rb_tree_node_base"*, align 8
  store %"struct.std::_Rb_tree_node_base"* %__x, %"struct.std::_Rb_tree_node_base"** %__x.addr, align 8
  %0 = load %"struct.std::_Rb_tree_node_base"*, %"struct.std::_Rb_tree_node_base"** %__x.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local void @_ZNSt8_Rb_treeIPKvSt4pairIKS1_jESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE12_M_drop_nodeEPSt13_Rb_tree_nodeIS4_E(%"class.std::_Rb_tree"* nonnull dereferenceable(48) %this, %"struct.std::_Rb_tree_node.49"* %__p) #9 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::_Rb_tree"*, align 8
  ...
  call void @_ZNSt8_Rb_treeIPKvSt4pairIKS1_jESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE15_M_destroy_nodeEPSt13_Rb_tree_nodeIS4_E(%"class.std::_Rb_tree"* nonnull dereferenceable(48) %this1, %"struct.std::_Rb_tree_node.49"* %0) #3
  %1 = load %"struct.std::_Rb_tree_node.49"*, %"struct.std::_Rb_tree_node.49"** %__p.addr, align 8
  call void @_ZNSt8_Rb_treeIPKvSt4pairIKS1_jESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE11_M_put_nodeEPSt13_Rb_tree_nodeIS4_E(%"class.std::_Rb_tree"* nonnull dereferenceable(48) %this1, %"struct.std::_Rb_tree_node.49"* %1) #3
  ret void
}

; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local void @_ZNSt8_Rb_treeIPKvSt4pairIKS1_jESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE15_M_destroy_nodeEPSt13_Rb_tree_nodeIS4_E(%"class.std::_Rb_tree"* nonnull dereferenceable(48) %this, %"struct.std::_Rb_tree_node.49"* %__p) #9 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
  %this.addr = alloca %"class.std::_Rb_tree"*, align 8
  %__p.addr = alloca %"struct.std::_Rb_tree_node.49"*, align 8
  store %"class.std::_Rb_tree"* %this, %"class.std::_Rb_tree"** %this.addr, align 8
  ...
  %0 = load %"struct.std::_Rb_tree_node.49"*, %"struct.std::_Rb_tree_node.49"** %__p.addr, align 8
  %call2 = invoke %"struct.std::pair.51"* @_ZNSt13_Rb_tree_nodeISt4pairIKPKvjEE9_M_valptrEv(%"struct.std::_Rb_tree_node.49"* nonnull dereferenceable(48) %0)
          to label %invoke.cont unwind label %terminate.lpad

invoke.cont:                                      ; preds = %entry
  call void @_ZNSt16allocator_traitsISaISt13_Rb_tree_nodeISt4pairIKPKvjEEEE7destroyIS5_EEvRS7_PT_(%"class.std::allocator"* nonnull align 1 dereferenceable(1) %call, %"struct.std::pair.51"* %call2) #3
  %1 = load %"struct.std::_Rb_tree_node.49"*, %"struct.std::_Rb_tree_node.49"** %__p.addr, align 8
  ret void
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local void @_ZNSt8_Rb_treeIPKvSt4pairIKS1_jESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE11_M_put_nodeEPSt13_Rb_tree_nodeIS4_E(%"class.std::_Rb_tree"* nonnull dereferenceable(48) %this, %"struct.std::_Rb_tree_node.49"* %__p) #9 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
  %this.addr = alloca %"class.std::_Rb_tree"*, align 8
  %__p.addr = alloca %"struct.std::_Rb_tree_node.49"*, align 8
  store %"class.std::_Rb_tree"* %this, %"class.std::_Rb_tree"** %this.addr, align 8
  ...
  %call = call nonnull align 1 dereferenceable(1) %"class.std::allocator"* @_ZNSt8_Rb_treeIPKvSt4pairIKS1_jESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE21_M_get_Node_allocatorEv(%"class.std::_Rb_tree"* nonnull dereferenceable(48) %this1) #3
  %0 = load %"struct.std::_Rb_tree_node.49"*, %"struct.std::_Rb_tree_node.49"** %__p.addr, align 8
  invoke void @_ZNSt16allocator_traitsISaISt13_Rb_tree_nodeISt4pairIKPKvjEEEE10deallocateERS7_PS6_m(%"class.std::allocator"* nonnull align 1 dereferenceable(1) %call, %"struct.std::_Rb_tree_node.49"* %0, i64 1)
          to label %invoke.cont unwind label %terminate.lpad
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local void @_ZNSt16allocator_traitsISaISt13_Rb_tree_nodeISt4pairIKPKvjEEEE7destroyIS5_EEvRS7_PT_(%"class.std::allocator"* nonnull align 1 dereferenceable(1) %__a, %"struct.std::pair.51"* %__p) #9 comdat align 2 {
entry:
  ...
  call void @_ZN9__gnu_cxx13new_allocatorISt13_Rb_tree_nodeISt4pairIKPKvjEEE7destroyIS6_EEvPT_(%"class.__gnu_cxx::new_allocator"* nonnull dereferenceable(1) %1, %"struct.std::pair.51"* %2) #3
  ret void
}

; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local nonnull align 1 dereferenceable(1) %"class.std::allocator"* @_ZNSt8_Rb_treeIPKvSt4pairIKS1_jESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE21_M_get_Node_allocatorEv(%"class.std::_Rb_tree"* nonnull dereferenceable(48) %this) #9 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::_Rb_tree"*, align 8
  store %"class.std::_Rb_tree"* %this, %"class.std::_Rb_tree"** %this.addr, align 8
  %this1 = load %"class.std::_Rb_tree"*, %"class.std::_Rb_tree"** %this.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local %"struct.std::pair.51"* @_ZNSt13_Rb_tree_nodeISt4pairIKPKvjEE9_M_valptrEv(%"struct.std::_Rb_tree_node.49"* nonnull dereferenceable(48) %this) #9 comdat align 2 {
entry:
  ...
  %call = call %"struct.std::pair.51"* @_ZN9__gnu_cxx16__aligned_membufISt4pairIKPKvjEE6_M_ptrEv(%"struct.__gnu_cxx::__aligned_membuf.50"* nonnull dereferenceable(16) %_M_storage) #3
  ret %"struct.std::pair.51"* %call
}

; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local void @_ZN9__gnu_cxx13new_allocatorISt13_Rb_tree_nodeISt4pairIKPKvjEEE7destroyIS6_EEvPT_(%"class.__gnu_cxx::new_allocator"* nonnull dereferenceable(1) %this, %"struct.std::pair.51"* %__p) #9 comdat align 2 {
entry:
  %this.addr = alloca %"class.__gnu_cxx::new_allocator"*, align 8
  %__p.addr = alloca %"struct.std::pair.51"*, align 8
  store %"class.__gnu_cxx::new_allocator"* %this, %"class.__gnu_cxx::new_allocator"** %this.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local %"struct.std::pair.51"* @_ZN9__gnu_cxx16__aligned_membufISt4pairIKPKvjEE6_M_ptrEv(%"struct.__gnu_cxx::__aligned_membuf.50"* nonnull dereferenceable(16) %this) #9 comdat align 2 {
entry:
  ...
  %call = call i8* @_ZN9__gnu_cxx16__aligned_membufISt4pairIKPKvjEE7_M_addrEv(%"struct.__gnu_cxx::__aligned_membuf.50"* nonnull dereferenceable(16) %this1) #3
  %0 = bitcast i8* %call to %"struct.std::pair.51"*
  ret %"struct.std::pair.51"* %0
}

; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local i8* @_ZN9__gnu_cxx16__aligned_membufISt4pairIKPKvjEE7_M_addrEv(%"struct.__gnu_cxx::__aligned_membuf.50"* nonnull dereferenceable(16) %this) #9 comdat align 2 {
entry:
  %this.addr = alloca %"struct.__gnu_cxx::__aligned_membuf.50"*, align 8
  store %"struct.__gnu_cxx::__aligned_membuf.50"* %this, %"struct.__gnu_cxx::__aligned_membuf.50"** %this.addr, align 8
  %this1 = load %"struct.__gnu_cxx::__aligned_membuf.50"*, %"struct.__gnu_cxx::__aligned_membuf.50"** %this.addr, align 8
...
; Function Attrs: noinline optnone uwtable mustprogress
define linkonce_odr dso_local void @_ZNSt16allocator_traitsISaISt13_Rb_tree_nodeISt4pairIKPKvjEEEE10deallocateERS7_PS6_m(%"class.std::allocator"* nonnull align 1 dereferenceable(1) %__a, %"struct.std::_Rb_tree_node.49"* %__p, i64 %__n) #4 comdat align 2 {
entry:
  %__a.addr = alloca %"class.std::allocator"*, align 8
  %__p.addr = alloca %"struct.std::_Rb_tree_node.49"*, align 8
  %__n.addr = alloca i64, align 8
  ...
  %3 = load i64, i64* %__n.addr, align 8
  call void @_ZN9__gnu_cxx13new_allocatorISt13_Rb_tree_nodeISt4pairIKPKvjEEE10deallocateEPS7_m(%"class.__gnu_cxx::new_allocator"* nonnull dereferenceable(1) %1, %"struct.std::_Rb_tree_node.49"* %2, i64 %3)
  ret void
}

; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local void @_ZN9__gnu_cxx13new_allocatorISt13_Rb_tree_nodeISt4pairIKPKvjEEE10deallocateEPS7_m(%"class.__gnu_cxx::new_allocator"* nonnull dereferenceable(1) %this, %"struct.std::_Rb_tree_node.49"* %__p, i64 %0) #9 comdat align 2 {
entry:
  %this.addr = alloca %"class.__gnu_cxx::new_allocator"*, align 8
  %__p.addr = alloca %"struct.std::_Rb_tree_node.49"*, align 8
  %.addr = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSaISt13_Rb_tree_nodeISt4pairIKPKvjEEED2Ev(%"class.std::allocator"* nonnull dereferenceable(1) %this) unnamed_addr #8 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::allocator"*, align 8
  store %"class.std::allocator"* %this, %"class.std::allocator"** %this.addr, align 8
  %this1 = load %"class.std::allocator"*, %"class.std::allocator"** %this.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZN9__gnu_cxx13new_allocatorISt13_Rb_tree_nodeISt4pairIKPKvjEEED2Ev(%"class.__gnu_cxx::new_allocator"* nonnull dereferenceable(1) %this) unnamed_addr #8 comdat align 2 {
entry:
  %this.addr = alloca %"class.__gnu_cxx::new_allocator"*, align 8
  store %"class.__gnu_cxx::new_allocator"* %this, %"class.__gnu_cxx::new_allocator"** %this.addr, align 8
  %this1 = load %"class.__gnu_cxx::new_allocator"*, %"class.__gnu_cxx::new_allocator"** %this.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt10_HashtableINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_mESaIS8_ENSt8__detail10_Select1stESt8equal_toIS5_ESt4hashIS5_ENSA_18_Mod_range_hashingENSA_20_Default_ranged_hashENSA_20_Prime_rehash_policyENSA_17_Hashtable_traitsILb1ELb0ELb1EEEEC2Ev(%"class.std::_Hashtable"* nonnull dereferenceable(56) %this) unnamed_addr #8 comdat align 2 {
entry:
  ...
  %0 = bitcast %"class.std::_Hashtable"* %this1 to %"struct.std::__detail::_Hashtable_base"*
  %1 = bitcast %"class.std::_Hashtable"* %this1 to %"struct.std::__detail::_Map_base"*
  %2 = bitcast %"class.std::_Hashtable"* %this1 to %"struct.std::__detail::_Insert"*
  %3 = bitcast %"class.std::_Hashtable"* %this1 to %"struct.std::__detail::_Rehash_base"*
  %4 = bitcast %"class.std::_Hashtable"* %this1 to %"struct.std::__detail::_Equality"*
  %5 = bitcast %"class.std::_Hashtable"* %this1 to %"struct.std::__detail::_Hashtable_alloc"*
  call void @_ZNSt8__detail16_Hashtable_allocISaINS_10_Hash_nodeISt4pairIKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEmELb1EEEEEC2Ev(%"struct.std::__detail::_Hashtable_alloc"* nonnull dereferenceable(1) %5) #3
  ...
  store %"struct.std::__detail::_Hash_node_base"** %_M_single_bucket, %"struct.std::__detail::_Hash_node_base"*** %_M_buckets, align 8
  %_M_bucket_count = getelementptr inbounds %"class.std::_Hashtable", %"class.std::_Hashtable"* %this1, i32 0, i32 1
  store i64 1, i64* %_M_bucket_count, align 8
  %_M_before_begin = getelementptr inbounds %"class.std::_Hashtable", %"class.std::_Hashtable"* %this1, i32 0, i32 2
  call void @_ZNSt8__detail15_Hash_node_baseC2Ev(%"struct.std::__detail::_Hash_node_base"* nonnull dereferenceable(8) %_M_before_begin) #3
  %_M_element_count = getelementptr inbounds %"class.std::_Hashtable", %"class.std::_Hashtable"* %this1, i32 0, i32 3
  store i64 0, i64* %_M_element_count, align 8
  %_M_rehash_policy = getelementptr inbounds %"class.std::_Hashtable", %"class.std::_Hashtable"* %this1, i32 0, i32 4
  call void @_ZNSt8__detail20_Prime_rehash_policyC2Ef(%"struct.std::__detail::_Prime_rehash_policy"* nonnull dereferenceable(16) %_M_rehash_policy, float 1.000000e+00) #3
  %_M_single_bucket2 = getelementptr inbounds %"class.std::_Hashtable", %"class.std::_Hashtable"* %this1, i32 0, i32 5
  store %"struct.std::__detail::_Hash_node_base"* null, %"struct.std::__detail::_Hash_node_base"** %_M_single_bucket2, align 8
  ret void
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt8__detail16_Hashtable_allocISaINS_10_Hash_nodeISt4pairIKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEmELb1EEEEEC2Ev(%"struct.std::__detail::_Hashtable_alloc"* nonnull dereferenceable(1) %this) unnamed_addr #8 comdat align 2 {
entry:
  ...
  call void @_ZNSt8__detail21_Hashtable_ebo_helperILi0ESaINS_10_Hash_nodeISt4pairIKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEmELb1EEEELb1EEC2Ev(%"struct.std::__detail::_Hashtable_ebo_helper.27"* nonnull dereferenceable(1) %0) #3
  ret void
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt8__detail15_Hash_node_baseC2Ev(%"struct.std::__detail::_Hash_node_base"* nonnull dereferenceable(8) %this) unnamed_addr #8 comdat align 2 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt8__detail20_Prime_rehash_policyC2Ef(%"struct.std::__detail::_Prime_rehash_policy"* nonnull dereferenceable(16) %this, float %__z) unnamed_addr #8 comdat align 2 {
entry:
  ...
  %_M_max_load_factor = getelementptr inbounds %"struct.std::__detail::_Prime_rehash_policy", %"struct.std::__detail::_Prime_rehash_policy"* %this1, i32 0, i32 0
  %0 = load float, float* %__z.addr, align 4
  store float %0, float* %_M_max_load_factor, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt8__detail21_Hashtable_ebo_helperILi0ESaINS_10_Hash_nodeISt4pairIKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEmELb1EEEELb1EEC2Ev(%"struct.std::__detail::_Hashtable_ebo_helper.27"* nonnull dereferenceable(1) %this) unnamed_addr #8 comdat align 2 {
entry:
  %this.addr = alloca %"struct.std::__detail::_Hashtable_ebo_helper.27"*, align 8
  store %"struct.std::__detail::_Hashtable_ebo_helper.27"* %this, %"struct.std::__detail::_Hashtable_ebo_helper.27"** %this.addr, align 8
  %this1 = load %"struct.std::__detail::_Hashtable_ebo_helper.27"*, %"struct.std::__detail::_Hashtable_ebo_helper.27"** %this.addr, align 8
  %0 = bitcast %"struct.std::__detail::_Hashtable_ebo_helper.27"* %this1 to %"class.std::allocator.28"*
  call void @_ZNSaINSt8__detail10_Hash_nodeISt4pairIKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEmELb1EEEEC2Ev(%"class.std::allocator.28"* nonnull dereferenceable(1) %0) #3
  ret void
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSaINSt8__detail10_Hash_nodeISt4pairIKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEmELb1EEEEC2Ev(%"class.std::allocator.28"* nonnull dereferenceable(1) %this) unnamed_addr #8 comdat align 2 {
entry:
  ...
  call void @_ZN9__gnu_cxx13new_allocatorINSt8__detail10_Hash_nodeISt4pairIKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEmELb1EEEEC2Ev(%"class.__gnu_cxx::new_allocator.29"* nonnull dereferenceable(1) %0) #3
  ret void
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZN9__gnu_cxx13new_allocatorINSt8__detail10_Hash_nodeISt4pairIKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEmELb1EEEEC2Ev(%"class.__gnu_cxx::new_allocator.29"* nonnull dereferenceable(1) %this) unnamed_addr #8 comdat align 2 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local zeroext i1 @_ZNSt6atomicIN5rlbox13rlbox_sandboxINS0_20rlbox_wasm2c_sandboxEE14Sandbox_StatusEE23compare_exchange_strongERS4_S4_St12memory_order(%"struct.std::atomic"* nonnull dereferenceable(4) %this, i32* nonnull align 4 dereferenceable(4) %__e, i32 %__i, i32 %__m) #9 comdat align 2 {
entry:
  %this.addr = alloca %"struct.std::atomic"*, align 8
...
if.then:                                          ; preds = %entry
  ...
  call void @_ZN5rlbox6detail13dynamic_checkEbPKc(i1 zeroext %cmp, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.3, i64 0, i64 0))
  br label %if.end5
...
if.then4:                                         ; preds = %if.else
  call void @_ZN5rlbox20rlbox_wasm2c_sandbox20impl_destroy_sandboxEv(%"class.rlbox::rlbox_wasm2c_sandbox"* nonnull dereferenceable(2840) %this1)
...
if.end5:                                          ; preds = %if.end, %if.then
  ...
  call void @_ZNSaIcEC1Ev(%"class.std::allocator.41"* nonnull dereferenceable(1) %ref.tmp) #3
  invoke void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC2IS3_EEPKcRKS3_(%"class.std::__cxx11::basic_string"* nonnull dereferenceable(32) %wasm_module_name_str, i8* %3, %"class.std::allocator.41"* nonnull align 1 dereferenceable(1) %ref.tmp)
          to label %invoke.cont unwind label %lpad

invoke.cont:                                      ; preds = %if.end5
  call void @_ZNSaIcED1Ev(%"class.std::allocator.41"* nonnull dereferenceable(1) %ref.tmp) #3
...
if.then7:                                         ; preds = %invoke.cont
  ...
  invoke void @_ZN5rlbox6detail13dynamic_checkEbPKc(i1 zeroext %call, i8* getelementptr inbounds ([55 x i8], [55 x i8]* @.str.4, i64 0, i64 0))
...
if.then12:                                        ; preds = %if.else10
  invoke void @_ZN5rlbox20rlbox_wasm2c_sandbox20impl_destroy_sandboxEv(%"class.rlbox::rlbox_wasm2c_sandbox"* nonnull dereferenceable(2840) %this1)
...
if.then17:                                        ; preds = %if.end15
  ...
  invoke void @_ZN5rlbox6detail13dynamic_checkEbPKc(i1 zeroext %cmp18, i8* getelementptr inbounds ([59 x i8], [59 x i8]* @.str.5, i64 0, i64 0))
...
if.end25:                                         ; preds = %if.end24, %invoke.cont19
  ...
  invoke void %14(%struct.wasm2c_sandbox_funcs_t* sret(%struct.wasm2c_sandbox_funcs_t) align 8 %ref.tmp26)
...
if.then35:                                        ; preds = %invoke.cont32
  ...
  invoke void @_ZN5rlbox6detail13dynamic_checkEbPKc(i1 zeroext %cmp36, i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.6, i64 0, i64 0))
...
if.then49:                                        ; preds = %invoke.cont45
  ...
  invoke void @_ZN5rlbox6detail13dynamic_checkEbPKc(i1 zeroext %cmp51, i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.7, i64 0, i64 0))
...
if.end59:                                         ; preds = %if.end58, %invoke.cont52
  ...
  %call63 = invoke i8* %28(i8* %29, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.8, i64 0, i64 0))
...
if.then65:                                        ; preds = %invoke.cont62
  ...
  invoke void @_ZN5rlbox6detail13dynamic_checkEbPKc(i1 zeroext %cmp67, i8* getelementptr inbounds ([41 x i8], [41 x i8]* @.str.9, i64 0, i64 0))
...
if.end75:                                         ; preds = %if.end74, %invoke.cont68
  %call77 = invoke i8* @_ZNK5rlbox20rlbox_wasm2c_sandbox24impl_get_memory_locationEv(%"class.rlbox::rlbox_wasm2c_sandbox"* nonnull dereferenceable(2840) %this1)
...
if.then81:                                        ; preds = %invoke.cont76
  ...
  invoke void @_ZN5rlbox6detail13dynamic_checkEbPKc(i1 zeroext %cmp83, i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str.10, i64 0, i64 0))
...
if.end92:                                         ; preds = %if.end91, %invoke.cont84
  ...
  %41 = load atomic i8, i8* bitcast (i64* @_ZGVZN5rlbox20rlbox_wasm2c_sandbox19impl_create_sandboxEbmPKcE3sbb to i8*) acquire, align 8
  %guard.uninitialized = icmp eq i8 %41, 0
  br i1 %guard.uninitialized, label %init.check, label %init.end, !prof !9

init.check:                                       ; preds = %if.end92
  %42 = call i32 @__cxa_guard_acquire(i64* @_ZGVZN5rlbox20rlbox_wasm2c_sandbox19impl_create_sandboxEbmPKcE3sbb) #3
  %tobool94 = icmp ne i32 %42, 0
  br i1 %tobool94, label %init, label %init.end

init:                                             ; preds = %init.check
  %exec_env95 = getelementptr inbounds %"class.rlbox::rlbox_wasm2c_sandbox", %"class.rlbox::rlbox_wasm2c_sandbox"* %this1, i32 0, i32 4
  %43 = load i8*, i8** %exec_env95, align 8
  %44 = bitcast i8* %43 to %struct.wasm2c_sandbox_t*
  store %struct.wasm2c_sandbox_t* %44, %struct.wasm2c_sandbox_t** @_ZZN5rlbox20rlbox_wasm2c_sandbox19impl_create_sandboxEbmPKcE3sbb, align 8
  call void @__cxa_guard_release(i64* @_ZGVZN5rlbox20rlbox_wasm2c_sandbox19impl_create_sandboxEbmPKcE3sbb) #3
  br label %init.end

init.end:                                         ; preds = %init, %init.check, %if.end92
  %45 = load %struct.wasm2c_sandbox_t*, %struct.wasm2c_sandbox_t** @_ZZN5rlbox20rlbox_wasm2c_sandbox19impl_create_sandboxEbmPKcE3sbb, align 8
  %sbb_nc = getelementptr inbounds %"class.rlbox::rlbox_wasm2c_sandbox", %"class.rlbox::rlbox_wasm2c_sandbox"* %this1, i32 0, i32 5
  store %struct.wasm2c_sandbox_t* %45, %struct.wasm2c_sandbox_t** %sbb_nc, align 8
  %malloc_index = getelementptr inbounds %"class.rlbox::rlbox_wasm2c_sandbox", %"class.rlbox::rlbox_wasm2c_sandbox"* %this1, i32 0, i32 6
...
cleanup:                                          ; preds = %init.end, %invoke.cont90, %invoke.cont73, %invoke.cont57, %invoke.cont41, %invoke.cont23, %invoke.cont13
  call void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED1Ev(%"class.std::__cxx11::basic_string"* nonnull dereferenceable(32) %wasm_module_name_str) #3
  br label %return
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local void @_ZNSt6atomicIN5rlbox13rlbox_sandboxINS0_20rlbox_wasm2c_sandboxEE14Sandbox_StatusEE5storeES4_St12memory_order(%"struct.std::atomic"* nonnull dereferenceable(4) %this, i32 %__i, i32 %__m) #9 comdat align 2 {
entry:
  %this.addr = alloca %"struct.std::atomic"*, align 8
  %__i.addr = alloca i32, align 4
  %__m.addr = alloca i32, align 4
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local void @_ZNSt11unique_lockISt18shared_timed_mutexEC2ERS0_(%"class.std::unique_lock"* nonnull dereferenceable(9) %this, %"class.std::shared_timed_mutex"* nonnull align 8 dereferenceable(56) %__m) unnamed_addr #6 comdat align 2 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt11unique_lockISt18shared_timed_mutexED2Ev(%"class.std::unique_lock"* nonnull dereferenceable(9) %this) unnamed_addr #8 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
  %this.addr = alloca %"class.std::unique_lock"*, align 8
  store %"class.std::unique_lock"* %this, %"class.std::unique_lock"** %this.addr, align 8
  %this1 = load %"class.std::unique_lock"*, %"class.std::unique_lock"** %this.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local i32 @_ZSt23__cmpexch_failure_orderSt12memory_order(i32 %__m) #9 comdat personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
  %__m.addr = alloca i32, align 4
  store i32 %__m, i32* %__m.addr, align 4
  %0 = load i32, i32* %__m.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local i32* @_ZSt11__addressofIN5rlbox13rlbox_sandboxINS0_20rlbox_wasm2c_sandboxEE14Sandbox_StatusEEPT_RS5_(i32* nonnull align 4 dereferenceable(4) %__r) #9 comdat {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local i32 @_ZStorSt12memory_orderSt23__memory_order_modifier(i32 %__m, i32 %__mod) #9 comdat {
entry:
  %__m.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local i32 @_ZSt24__cmpexch_failure_order2St12memory_order(i32 %__m) #9 comdat {
entry:
  %__m.addr = alloca i32, align 4
  store i32 %__m, i32* %__m.addr, align 4
  %0 = load i32, i32* %__m.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local i32 @_ZStanSt12memory_orderSt23__memory_order_modifier(i32 %__m, i32 %__mod) #9 comdat {
entry:
  %__m.addr = alloca i32, align 4
  %__mod.addr = alloca i32, align 4
  store i32 %__m, i32* %__m.addr, align 4
...
declare dso_local nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* nonnull align 8 dereferenceable(8), i8*) #18

; Function Attrs: tainted
declare dso_local nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSolsEPFRSoS_E(%"class.std::basic_ostream"* nonnull dereferenceable(8), %"class.std::basic_ostream"* (%"class.std::basic_ostream"*)*) #18

declare dso_local nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_(%"class.std::basic_ostream"* nonnull align 8 dereferenceable(8)) #1

; Function Attrs: noreturn nounwind
declare dso_local void @abort() #19

; Function Attrs: noinline optnone uwtable mustprogress
define linkonce_odr dso_local void @_ZN5rlbox20rlbox_wasm2c_sandbox20impl_destroy_sandboxEv(%"class.rlbox::rlbox_wasm2c_sandbox"* nonnull dereferenceable(2840) %this) #4 comdat align 2 {
entry:
  %this.addr = alloca %"class.rlbox::rlbox_wasm2c_sandbox"*, align 8
  store %"class.rlbox::rlbox_wasm2c_sandbox"* %this, %"class.rlbox::rlbox_wasm2c_sandbox"** %this.addr, align 8
  %this1 = load %"class.rlbox::rlbox_wasm2c_sandbox"*, %"class.rlbox::rlbox_wasm2c_sandbox"** %this.addr, align 8
...
if.then:                                          ; preds = %entry
  ...
  call void @_ZN5rlbox20rlbox_wasm2c_sandbox20impl_free_in_sandboxEj(%"class.rlbox::rlbox_wasm2c_sandbox"* nonnull dereferenceable(2840) %this1, i32 %1)
  br label %if.end
...
; Function Attrs: nounwind
declare dso_local void @_ZNSaIcEC1Ev(%"class.std::allocator.41"* nonnull dereferenceable(1)) unnamed_addr #2

; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC2IS3_EEPKcRKS3_(%"class.std::__cxx11::basic_string"* nonnull dereferenceable(32) %this, i8* %__s, %"class.std::allocator.41"* nonnull align 1 dereferenceable(1) %__a) unnamed_addr #6 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
  %this.addr = alloca %"class.std::__cxx11::basic_string"*, align 8
  %__s.addr = alloca i8*, align 8
  %__a.addr = alloca %"class.std::allocator.41"*, align 8
  %exn.slot = alloca i8*, align 8
  %ehselector.slot = alloca i32, align 4
  store %"class.std::__cxx11::basic_string"* %this, %"class.std::__cxx11::basic_string"** %this.addr, align 8
  store i8* %__s, i8** %__s.addr, align 8
  store %"class.std::allocator.41"* %__a, %"class.std::allocator.41"** %__a.addr, align 8
  ...
  %0 = load %"class.std::allocator.41"*, %"class.std::allocator.41"** %__a.addr, align 8
  call void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE12_Alloc_hiderC1EPcRKS3_(%"struct.std::__cxx11::basic_string<char>::_Alloc_hider"* nonnull dereferenceable(8) %_M_dataplus, i8* %call, %"class.std::allocator.41"* nonnull align 1 dereferenceable(1) %0)
...
; Function Attrs: nounwind
declare dso_local void @_ZNSaIcED1Ev(%"class.std::allocator.41"* nonnull dereferenceable(1)) unnamed_addr #2
...
declare dso_local void @get_wasm2c_sandbox_info(%struct.wasm2c_sandbox_funcs_t* sret(%struct.wasm2c_sandbox_funcs_t) align 8) #1
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local i64 @_ZN5rlbox20rlbox_wasm2c_sandbox32rlbox_wasm2c_get_heap_page_countEm(i64 %heap_size) #9 comdat align 2 {
entry:
  %heap_size.addr = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local i8* @_ZNK5rlbox20rlbox_wasm2c_sandbox24impl_get_memory_locationEv(%"class.rlbox::rlbox_wasm2c_sandbox"* nonnull dereferenceable(2840) %this) #9 comdat align 2 {
entry:
  %this.addr = alloca %"class.rlbox::rlbox_wasm2c_sandbox"*, align 8
  store %"class.rlbox::rlbox_wasm2c_sandbox"* %this, %"class.rlbox::rlbox_wasm2c_sandbox"** %this.addr, align 8
  %this1 = load %"class.rlbox::rlbox_wasm2c_sandbox"*, %"class.rlbox::rlbox_wasm2c_sandbox"** %this.addr, align 8
...
; Function Attrs: noinline nounwind optnone tainted uwtable mustprogress
define linkonce_odr dso_local i32 @_ZNSt14numeric_limitsIjE3maxEv() #17 comdat align 2 {
entry:
  ret i32 -1
}
...
; Function Attrs: noinline optnone uwtable mustprogress
define linkonce_odr dso_local void @_ZN5rlbox20rlbox_wasm2c_sandbox20impl_free_in_sandboxEj(%"class.rlbox::rlbox_wasm2c_sandbox"* nonnull dereferenceable(2840) %this, i32 %p) #4 comdat align 2 {
entry:
  %this.addr = alloca %"class.rlbox::rlbox_wasm2c_sandbox"*, align 8
  ...
  call void @_ZN5rlbox20rlbox_wasm2c_sandbox25impl_invoke_with_func_ptrIFvPvEFvjEJRjEEEDaPT0_DpOT1_(%"class.rlbox::rlbox_wasm2c_sandbox"* nonnull dereferenceable(2840) %this1, void (i32)* %1, i32* nonnull align 4 dereferenceable(4) %p.addr)
  ret void
}

; Function Attrs: noinline optnone uwtable mustprogress
define linkonce_odr dso_local void @_ZN5rlbox20rlbox_wasm2c_sandbox25impl_invoke_with_func_ptrIFvPvEFvjEJRjEEEDaPT0_DpOT1_(%"class.rlbox::rlbox_wasm2c_sandbox"* nonnull dereferenceable(2840) %this, void (i32)* %func_ptr, i32* nonnull align 4 dereferenceable(4) %params) #4 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
  %this.addr = alloca %"class.rlbox::rlbox_wasm2c_sandbox"*, align 8
  ...
  %serialize_class_arg = alloca %class.anon.54, align 8
  ...
  %1 = getelementptr inbounds %class.anon, %class.anon* %ref.tmp, i32 0, i32 0
  store %"class.rlbox::rlbox_wasm2c_sandbox"** %old_sandbox, %"class.rlbox::rlbox_wasm2c_sandbox"*** %1, align 8
  call void @_ZN5rlbox6detail15make_scope_exitIZNS_20rlbox_wasm2c_sandbox25impl_invoke_with_func_ptrIFvPvEFvjEJRjEEEDaPT0_DpOT1_EUlvE_EENS0_10scope_exitIT_EEOSF_(%"class.rlbox::detail::scope_exit"* sret(%"class.rlbox::detail::scope_exit") align 8 %on_exit, %class.anon* nonnull align 8 dereferenceable(8) %ref.tmp)
  ...
  %2 = getelementptr inbounds %class.anon.54, %class.anon.54* %serialize_class_arg, i32 0, i32 0
  store %"class.rlbox::rlbox_wasm2c_sandbox"* %this1, %"class.rlbox::rlbox_wasm2c_sandbox"** %2, align 8
  %3 = getelementptr inbounds %class.anon.54, %class.anon.54* %serialize_class_arg, i32 0, i32 1
  ...
  %call = invoke i32 @_ZZN5rlbox20rlbox_wasm2c_sandbox25impl_invoke_with_func_ptrIFvPvEFvjEJRjEEEDaPT0_DpOT1_ENKUlT_E_clIjEENSt11conditionalIXsr3std8is_classIDtfp_EEE5valueEjSF_E4typeESB_(%class.anon.54* nonnull dereferenceable(16) %serialize_class_arg, i32 %10)
          to label %invoke.cont unwind label %lpad
...
for.body:                                         ; preds = %for.cond
  ...
  invoke void @_ZN5rlbox20rlbox_wasm2c_sandbox20impl_free_in_sandboxEj(%"class.rlbox::rlbox_wasm2c_sandbox"* nonnull dereferenceable(2840) %this1, i32 %13)
...
lpad:                                             ; preds = %for.body, %invoke.cont, %entry
  ...
  call void @_ZN5rlbox6detail10scope_exitIZNS_20rlbox_wasm2c_sandbox25impl_invoke_with_func_ptrIFvPvEFvjEJRjEEEDaPT0_DpOT1_EUlvE_ED2Ev(%"class.rlbox::detail::scope_exit"* nonnull dereferenceable(9) %on_exit) #3
  br label %eh.resume
...
; Function Attrs: noinline optnone uwtable mustprogress
define linkonce_odr dso_local void @_ZN5rlbox6detail15make_scope_exitIZNS_20rlbox_wasm2c_sandbox25impl_invoke_with_func_ptrIFvPvEFvjEJRjEEEDaPT0_DpOT1_EUlvE_EENS0_10scope_exitIT_EEOSF_(%"class.rlbox::detail::scope_exit"* noalias sret(%"class.rlbox::detail::scope_exit") align 8 %agg.result, %class.anon* nonnull align 8 dereferenceable(8) %exitFunction) #4 comdat {
entry:
  %result.ptr = alloca i8*, align 8
  %exitFunction.addr = alloca %class.anon*, align 8
  %0 = bitcast %"class.rlbox::detail::scope_exit"* %agg.result to i8*
  store i8* %0, i8** %result.ptr, align 8
  store %class.anon* %exitFunction, %class.anon** %exitFunction.addr, align 8
  %1 = load %class.anon*, %class.anon** %exitFunction.addr, align 8
  %call = call nonnull align 8 dereferenceable(8) %class.anon* @_ZSt4moveIRZN5rlbox20rlbox_wasm2c_sandbox25impl_invoke_with_func_ptrIFvPvEFvjEJRjEEEDaPT0_DpOT1_EUlvE_EONSt16remove_referenceIT_E4typeEOSF_(%class.anon* nonnull align 8 dereferenceable(8) %1) #3
  call void @_ZN5rlbox6detail10scope_exitIZNS_20rlbox_wasm2c_sandbox25impl_invoke_with_func_ptrIFvPvEFvjEJRjEEEDaPT0_DpOT1_EUlvE_EC2EOSD_(%"class.rlbox::detail::scope_exit"* nonnull dereferenceable(9) %agg.result, %class.anon* nonnull align 8 dereferenceable(8) %call)
  ret void
}

; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local i32 @_ZZN5rlbox20rlbox_wasm2c_sandbox25impl_invoke_with_func_ptrIFvPvEFvjEJRjEEEDaPT0_DpOT1_ENKUlT_E_clIjEENSt11conditionalIXsr3std8is_classIDtfp_EEE5valueEjSF_E4typeESB_(%class.anon.54* nonnull dereferenceable(16) %this, i32 %arg) #9 comdat align 2 {
entry:
  %this.addr = alloca %class.anon.54*, align 8
  %arg.addr = alloca i32, align 4
  store %class.anon.54* %this, %class.anon.54** %this.addr, align 8
  store i32 %arg, i32* %arg.addr, align 4
  %this1 = load %class.anon.54*, %class.anon.54** %this.addr, align 8
  %0 = getelementptr inbounds %class.anon.54, %class.anon.54* %this1, i32 0, i32 0
...
if.then:                                          ; preds = %entry
  ...
  invoke void @_ZZN5rlbox20rlbox_wasm2c_sandbox25impl_invoke_with_func_ptrIFvPvEFvjEJRjEEEDaPT0_DpOT1_ENKUlvE_clEv(%class.anon* nonnull dereferenceable(8) %exit_func)
          to label %invoke.cont unwind label %terminate.lpad
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local nonnull align 8 dereferenceable(8) %class.anon* @_ZSt4moveIRZN5rlbox20rlbox_wasm2c_sandbox25impl_invoke_with_func_ptrIFvPvEFvjEJRjEEEDaPT0_DpOT1_EUlvE_EONSt16remove_referenceIT_E4typeEOSF_(%class.anon* nonnull align 8 dereferenceable(8) %__t) #9 comdat {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZN5rlbox6detail10scope_exitIZNS_20rlbox_wasm2c_sandbox25impl_invoke_with_func_ptrIFvPvEFvjEJRjEEEDaPT0_DpOT1_EUlvE_EC2EOSD_(%"class.rlbox::detail::scope_exit"* nonnull dereferenceable(9) %this, %class.anon* nonnull align 8 dereferenceable(8) %cleanup) unnamed_addr #8 comdat align 2 {
entry:
  %this.addr = alloca %"class.rlbox::detail::scope_exit"*, align 8
  %cleanup.addr = alloca %class.anon*, align 8
  store %"class.rlbox::detail::scope_exit"* %this, %"class.rlbox::detail::scope_exit"** %this.addr, align 8
  store %class.anon* %cleanup, %class.anon** %cleanup.addr, align 8
  %this1 = load %"class.rlbox::detail::scope_exit"*, %"class.rlbox::detail::scope_exit"** %this.addr, align 8
  %exit_func = getelementptr inbounds %"class.rlbox::detail::scope_exit", %"class.rlbox::detail::scope_exit"* %this1, i32 0, i32 0
  %0 = load %class.anon*, %class.anon** %cleanup.addr, align 8
  %1 = bitcast %class.anon* %exit_func to i8*
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local void @_ZZN5rlbox20rlbox_wasm2c_sandbox25impl_invoke_with_func_ptrIFvPvEFvjEJRjEEEDaPT0_DpOT1_ENKUlvE_clEv(%class.anon* nonnull dereferenceable(8) %this) #9 comdat align 2 {
entry:
...
declare dso_local void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE12_Alloc_hiderC1EPcRKS3_(%"struct.std::__cxx11::basic_string<char>::_Alloc_hider"* nonnull dereferenceable(8), i8*, %"class.std::allocator.41"* nonnull align 1 dereferenceable(1)) unnamed_addr #1
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE12_Alloc_hiderD2Ev(%"struct.std::__cxx11::basic_string<char>::_Alloc_hider"* nonnull dereferenceable(8) %this) unnamed_addr #8 comdat align 2 {
entry:
  ...
  %0 = bitcast %"struct.std::__cxx11::basic_string<char>::_Alloc_hider"* %this1 to %"class.std::allocator.41"*
  call void @_ZNSaIcED2Ev(%"class.std::allocator.41"* nonnull dereferenceable(1) %0) #3
  ret void
}
...
if.then:                                          ; preds = %land.lhs.true
  call void @_ZSt19__throw_logic_errorPKc(i8* getelementptr inbounds ([42 x i8], [42 x i8]* @.str.11, i64 0, i64 0)) #23
  unreachable
...
terminate.lpad:                                   ; preds = %lpad8
  ...
  call void @__clang_call_terminate(i8* %19) #22
  unreachable
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local zeroext i1 @_ZN9__gnu_cxx17__is_null_pointerIKcEEbPT_(i8* %__ptr) #9 comdat {
entry:
...
; Function Attrs: nounwind tainted
declare dso_local void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE13_S_copy_charsEPcPKcS7_(i8*, i8*, i8*) #16

; Function Attrs: tainted
declare dso_local i8* @_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE7_M_dataEv(%"class.std::__cxx11::basic_string"* nonnull dereferenceable(32)) #18

; Function Attrs: tainted
declare dso_local void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE10_M_disposeEv(%"class.std::__cxx11::basic_string"* nonnull dereferenceable(32)) #18

; Function Attrs: tainted
declare dso_local void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE13_M_set_lengthEm(%"class.std::__cxx11::basic_string"* nonnull dereferenceable(32), i64) #18

; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local i64 @_ZSt10__distanceIPKcENSt15iterator_traitsIT_E15difference_typeES3_S3_St26random_access_iterator_tag(i8* %__first, i8* %__last) #9 comdat {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local void @_ZSt19__iterator_categoryIPKcENSt15iterator_traitsIT_E17iterator_categoryERKS3_(i8** nonnull align 8 dereferenceable(8) %0) #9 comdat {
entry:
  %.addr = alloca i8**, align 8
  store i8** %0, i8*** %.addr, align 8
  ret void
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local zeroext i1 @_ZN9__gnu_cxx11char_traitsIcE2eqERKcS3_(i8* nonnull align 1 dereferenceable(1) %__c1, i8* nonnull align 1 dereferenceable(1) %__c2) #9 comdat align 2 {
entry:
...
; Function Attrs: nounwind
declare dso_local void @_ZNSaIcED2Ev(%"class.std::allocator.41"* nonnull dereferenceable(1)) unnamed_addr #2

; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local i64 @_ZN5rlbox20rlbox_wasm2c_sandbox17next_power_of_twoEj(i32 %value) #9 comdat align 2 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local %"class.std::shared_timed_mutex"* @_ZSt11__addressofISt18shared_timed_mutexEPT_RS1_(%"class.std::shared_timed_mutex"* nonnull align 8 dereferenceable(56) %__r) #9 comdat {
entry:
...
if.then:                                          ; preds = %entry
  call void @_ZSt20__throw_system_errori(i32 1) #23
  unreachable
...
if.then3:                                         ; preds = %if.else
  call void @_ZSt20__throw_system_errori(i32 35) #23
  unreachable
...
; Function Attrs: noreturn
declare dso_local void @_ZSt20__throw_system_errori(i32) #14
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local nonnull align 8 dereferenceable(8) i8** @_ZSt4moveIRPvEONSt16remove_referenceIT_E4typeEOS3_(i8** nonnull align 8 dereferenceable(8) %__t) #9 comdat {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local void @_ZNSt16allocator_traitsISaIPvEE9constructIS0_JS0_EEEvRS1_PT_DpOT0_(%"class.std::allocator.21"* nonnull align 1 dereferenceable(1) %__a, i8** %__p, i8** nonnull align 8 dereferenceable(8) %__args) #9 comdat align 2 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local nonnull align 8 dereferenceable(8) i8** @_ZSt7forwardIPvEOT_RNSt16remove_referenceIS1_E4typeE(i8** nonnull align 8 dereferenceable(8) %__t) #9 comdat {
entry:
  %__t.addr = alloca i8**, align 8
  store i8** %__t, i8*** %__t.addr, align 8
  %0 = load i8**, i8*** %__t.addr, align 8
...
entry:
  ...
  store i8** %__args, i8*** %__args.addr, align 8
  %this1 = load %"class.std::vector"*, %"class.std::vector"** %this.addr, align 8
  %call = call i64 @_ZNKSt6vectorIPvSaIS0_EE12_M_check_lenEmPKc(%"class.std::vector"* nonnull dereferenceable(24) %this1, i64 1, i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.13, i64 0, i64 0))
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local i8** @_ZNSt6vectorIPvSaIS0_EE3endEv(%"class.std::vector"* nonnull dereferenceable(24) %this) #9 comdat align 2 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local nonnull align 8 dereferenceable(8) i8** @_ZNSt6vectorIPvSaIS0_EE4backEv(%"class.std::vector"* nonnull dereferenceable(24) %this) #9 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::vector"*, align 8
  %ref.tmp = alloca %"class.__gnu_cxx::__normal_iterator", align 8
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local void @_ZN9__gnu_cxx13new_allocatorIPvE9constructIS1_JS1_EEEvPT_DpOT0_(%"class.__gnu_cxx::new_allocator.22"* nonnull dereferenceable(1) %this, i8** %__p, i8** nonnull align 8 dereferenceable(8) %__args) #9 comdat align 2 {
entry:
...
if.then:                                          ; preds = %entry
  %1 = load i8*, i8** %__s.addr, align 8
  call void @_ZSt20__throw_length_errorPKc(i8* %1) #23
  unreachable
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local i64 @_ZN9__gnu_cxxmiIPPvSt6vectorIS1_SaIS1_EEEENS_17__normal_iteratorIT_T0_E15difference_typeERKS9_SC_(%"class.__gnu_cxx::__normal_iterator"* nonnull align 8 dereferenceable(8) %__lhs, %"class.__gnu_cxx::__normal_iterator"* nonnull align 8 dereferenceable(8) %__rhs) #9 comdat {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local i8** @_ZNSt6vectorIPvSaIS0_EE5beginEv(%"class.std::vector"* nonnull dereferenceable(24) %this) #9 comdat align 2 {
entry:
  %retval = alloca %"class.__gnu_cxx::__normal_iterator", align 8
  %this.addr = alloca %"class.std::vector"*, align 8
  store %"class.std::vector"* %this, %"class.std::vector"** %this.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local i8** @_ZNSt6vectorIPvSaIS0_EE11_S_relocateEPS0_S3_S3_RS1_(i8** %__first, i8** %__last, i8** %__result, %"class.std::allocator.21"* nonnull align 1 dereferenceable(1) %__alloc) #9 comdat align 2 {
entry:
  %__first.addr = alloca i8**, align 8
  %__last.addr = alloca i8**, align 8
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local nonnull align 8 dereferenceable(8) i8*** @_ZNK9__gnu_cxx17__normal_iteratorIPPvSt6vectorIS1_SaIS1_EEE4baseEv(%"class.__gnu_cxx::__normal_iterator"* nonnull dereferenceable(8) %this) #9 comdat align 2 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local nonnull align 1 dereferenceable(1) %"class.std::allocator.21"* @_ZNSt12_Vector_baseIPvSaIS0_EE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base"* nonnull dereferenceable(24) %this) #9 comdat align 2 {
entry:
  %this.addr = alloca %"struct.std::_Vector_base"*, align 8
  store %"struct.std::_Vector_base"* %this, %"struct.std::_Vector_base"** %this.addr, align 8
  %this1 = load %"struct.std::_Vector_base"*, %"struct.std::_Vector_base"** %this.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local i64 @_ZNKSt6vectorIPvSaIS0_EE8max_sizeEv(%"class.std::vector"* nonnull dereferenceable(24) %this) #9 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::vector"*, align 8
  store %"class.std::vector"* %this, %"class.std::vector"** %this.addr, align 8
  %this1 = load %"class.std::vector"*, %"class.std::vector"** %this.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local i64 @_ZNKSt6vectorIPvSaIS0_EE4sizeEv(%"class.std::vector"* nonnull dereferenceable(24) %this) #9 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::vector"*, align 8
  store %"class.std::vector"* %this, %"class.std::vector"** %this.addr, align 8
  %this1 = load %"class.std::vector"*, %"class.std::vector"** %this.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local nonnull align 8 dereferenceable(8) i64* @_ZSt3maxImERKT_S2_S2_(i64* nonnull align 8 dereferenceable(8) %__a, i64* nonnull align 8 dereferenceable(8) %__b) #9 comdat {
entry:
  %retval = alloca i64*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local i64 @_ZNSt6vectorIPvSaIS0_EE11_S_max_sizeERKS1_(%"class.std::allocator.21"* nonnull align 1 dereferenceable(1) %__a) #9 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
  %__a.addr = alloca %"class.std::allocator.21"*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local nonnull align 1 dereferenceable(1) %"class.std::allocator.21"* @_ZNKSt12_Vector_baseIPvSaIS0_EE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base"* nonnull dereferenceable(24) %this) #9 comdat align 2 {
entry:
  %this.addr = alloca %"struct.std::_Vector_base"*, align 8
  store %"struct.std::_Vector_base"* %this, %"struct.std::_Vector_base"** %this.addr, align 8
  %this1 = load %"struct.std::_Vector_base"*, %"struct.std::_Vector_base"** %this.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local i64 @_ZNSt16allocator_traitsISaIPvEE8max_sizeERKS1_(%"class.std::allocator.21"* nonnull align 1 dereferenceable(1) %__a) #9 comdat align 2 {
entry:
  %__a.addr = alloca %"class.std::allocator.21"*, align 8
  store %"class.std::allocator.21"* %__a, %"class.std::allocator.21"** %__a.addr, align 8
  %0 = load %"class.std::allocator.21"*, %"class.std::allocator.21"** %__a.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local nonnull align 8 dereferenceable(8) i64* @_ZSt3minImERKT_S2_S2_(i64* nonnull align 8 dereferenceable(8) %__a, i64* nonnull align 8 dereferenceable(8) %__b) #9 comdat {
entry:
  %retval = alloca i64*, align 8
  %__a.addr = alloca i64*, align 8
  %__b.addr = alloca i64*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local i64 @_ZNK9__gnu_cxx13new_allocatorIPvE8max_sizeEv(%"class.__gnu_cxx::new_allocator.22"* nonnull dereferenceable(1) %this) #9 comdat align 2 {
entry:
  %this.addr = alloca %"class.__gnu_cxx::new_allocator.22"*, align 8
  store %"class.__gnu_cxx::new_allocator.22"* %this, %"class.__gnu_cxx::new_allocator.22"** %this.addr, align 8
  %this1 = load %"class.__gnu_cxx::new_allocator.22"*, %"class.__gnu_cxx::new_allocator.22"** %this.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZN9__gnu_cxx17__normal_iteratorIPPvSt6vectorIS1_SaIS1_EEEC2ERKS2_(%"class.__gnu_cxx::__normal_iterator"* nonnull dereferenceable(8) %this, i8*** nonnull align 8 dereferenceable(8) %__i) unnamed_addr #8 comdat align 2 {
entry:
  %this.addr = alloca %"class.__gnu_cxx::__normal_iterator"*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local i8** @_ZNSt6vectorIPvSaIS0_EE14_S_do_relocateEPS0_S3_S3_RS1_St17integral_constantIbLb1EE(i8** %__first, i8** %__last, i8** %__result, %"class.std::allocator.21"* nonnull align 1 dereferenceable(1) %__alloc) #9 comdat align 2 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local i8** @_ZSt12__relocate_aIPPvS1_SaIS0_EET0_T_S4_S3_RT1_(i8** %__first, i8** %__last, i8** %__result, %"class.std::allocator.21"* nonnull align 1 dereferenceable(1) %__alloc) #9 comdat {
entry:
  %__first.addr = alloca i8**, align 8
  %__last.addr = alloca i8**, align 8
  %__result.addr = alloca i8**, align 8
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local i8** @_ZSt14__relocate_a_1IPvS0_ENSt9enable_ifIXsr3std24__is_bitwise_relocatableIT_EE5valueEPS2_E4typeES3_S3_S3_RSaIT0_E(i8** %__first, i8** %__last, i8** %__result, %"class.std::allocator.21"* nonnull align 1 dereferenceable(1) %0) #9 comdat {
entry:
  %__first.addr = alloca i8**, align 8
  %__last.addr = alloca i8**, align 8
  %__result.addr = alloca i8**, align 8
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local i8** @_ZSt12__niter_baseIPPvET_S2_(i8** %__it) #9 comdat {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local void @_ZN9__gnu_cxx13new_allocatorIPvE10deallocateEPS1_m(%"class.__gnu_cxx::new_allocator.22"* nonnull dereferenceable(1) %this, i8** %__p, i64 %0) #9 comdat align 2 {
entry:
  %this.addr = alloca %"class.__gnu_cxx::new_allocator.22"*, align 8
  %__p.addr = alloca i8**, align 8
  %.addr = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local i8** @_ZNK9__gnu_cxx17__normal_iteratorIPPvSt6vectorIS1_SaIS1_EEEmiEl(%"class.__gnu_cxx::__normal_iterator"* nonnull dereferenceable(8) %this, i64 %__n) #9 comdat align 2 {
entry:
  %retval = alloca %"class.__gnu_cxx::__normal_iterator", align 8
  %this.addr = alloca %"class.__gnu_cxx::__normal_iterator"*, align 8
  %__n.addr = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local nonnull align 8 dereferenceable(8) i8** @_ZNK9__gnu_cxx17__normal_iteratorIPPvSt6vectorIS1_SaIS1_EEEdeEv(%"class.__gnu_cxx::__normal_iterator"* nonnull dereferenceable(8) %this) #9 comdat align 2 {
entry:
  %this.addr = alloca %"class.__gnu_cxx::__normal_iterator"*, align 8
  store %"class.__gnu_cxx::__normal_iterator"* %this, %"class.__gnu_cxx::__normal_iterator"** %this.addr, align 8
  %this1 = load %"class.__gnu_cxx::__normal_iterator"*, %"class.__gnu_cxx::__normal_iterator"** %this.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define internal i32 @_ZStL23__glibcxx_rwlock_unlockP16pthread_rwlock_t(%union.pthread_rwlock_t* %__rwlock) #9 {
entry:
  %retval = alloca i32, align 4
  %__rwlock.addr = alloca %union.pthread_rwlock_t*, align 8
  store %union.pthread_rwlock_t* %__rwlock, %union.pthread_rwlock_t** %__rwlock.addr, align 8
...
invoke.cont:                                      ; preds = %entry
  %0 = bitcast %"class.std::_Hashtable"* %this1 to %"struct.std::__detail::_Hashtable_alloc"*
  call void @_ZNSt8__detail16_Hashtable_allocISaINS_10_Hash_nodeISt4pairIKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEmELb1EEEEED2Ev(%"struct.std::__detail::_Hashtable_alloc"* nonnull dereferenceable(1) %0) #3
  ret void
...
lpad:                                             ; preds = %entry
  ...
  %3 = extractvalue { i8*, i32 } %1, 1
  store i32 %3, i32* %ehselector.slot, align 4
  %4 = bitcast %"class.std::_Hashtable"* %this1 to %"struct.std::__detail::_Hashtable_alloc"*
  call void @_ZNSt8__detail16_Hashtable_allocISaINS_10_Hash_nodeISt4pairIKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEmELb1EEEEED2Ev(%"struct.std::__detail::_Hashtable_alloc"* nonnull dereferenceable(1) %4) #3
  br label %terminate.handler
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local void @_ZNSt10_HashtableINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_mESaIS8_ENSt8__detail10_Select1stESt8equal_toIS5_ESt4hashIS5_ENSA_18_Mod_range_hashingENSA_20_Default_ranged_hashENSA_20_Prime_rehash_policyENSA_17_Hashtable_traitsILb1ELb0ELb1EEEE5clearEv(%"class.std::_Hashtable"* nonnull dereferenceable(56) %this) #9 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
  %this.addr = alloca %"class.std::_Hashtable"*, align 8
  store %"class.std::_Hashtable"* %this, %"class.std::_Hashtable"** %this.addr, align 8
  %this1 = load %"class.std::_Hashtable"*, %"class.std::_Hashtable"** %this.addr, align 8
  %0 = bitcast %"class.std::_Hashtable"* %this1 to %"struct.std::__detail::_Hashtable_alloc"*
  %call = invoke %"struct.std::__detail::_Hash_node"* @_ZNKSt10_HashtableINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_mESaIS8_ENSt8__detail10_Select1stESt8equal_toIS5_ESt4hashIS5_ENSA_18_Mod_range_hashingENSA_20_Default_ranged_hashENSA_20_Prime_rehash_policyENSA_17_Hashtable_traitsILb1ELb0ELb1EEEE8_M_beginEv(%"class.std::_Hashtable"* nonnull dereferenceable(56) %this1)
          to label %invoke.cont unwind label %terminate.lpad

invoke.cont:                                      ; preds = %entry
  invoke void @_ZNSt8__detail16_Hashtable_allocISaINS_10_Hash_nodeISt4pairIKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEmELb1EEEEE19_M_deallocate_nodesEPSB_(%"struct.std::__detail::_Hashtable_alloc"* nonnull dereferenceable(1) %0, %"struct.std::__detail::_Hash_node"* %call)
          to label %invoke.cont2 unwind label %terminate.lpad

invoke.cont2:                                     ; preds = %invoke.cont
  %_M_buckets = getelementptr inbounds %"class.std::_Hashtable", %"class.std::_Hashtable"* %this1, i32 0, i32 0
  %1 = load %"struct.std::__detail::_Hash_node_base"**, %"struct.std::__detail::_Hash_node_base"*** %_M_buckets, align 8
...
terminate.lpad:                                   ; preds = %invoke.cont, %entry
  ...
  %5 = extractvalue { i8*, i32 } %4, 0
  call void @__clang_call_terminate(i8* %5) #22
  unreachable
}
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt8__detail16_Hashtable_allocISaINS_10_Hash_nodeISt4pairIKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEmELb1EEEEED2Ev(%"struct.std::__detail::_Hashtable_alloc"* nonnull dereferenceable(1) %this) unnamed_addr #8 comdat align 2 {
entry:
  %this.addr = alloca %"struct.std::__detail::_Hashtable_alloc"*, align 8
  store %"struct.std::__detail::_Hashtable_alloc"* %this, %"struct.std::__detail::_Hashtable_alloc"** %this.addr, align 8
  %this1 = load %"struct.std::__detail::_Hashtable_alloc"*, %"struct.std::__detail::_Hashtable_alloc"** %this.addr, align 8
  %0 = bitcast %"struct.std::__detail::_Hashtable_alloc"* %this1 to %"struct.std::__detail::_Hashtable_ebo_helper.27"*
  call void @_ZNSt8__detail21_Hashtable_ebo_helperILi0ESaINS_10_Hash_nodeISt4pairIKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEmELb1EEEELb1EED2Ev(%"struct.std::__detail::_Hashtable_ebo_helper.27"* nonnull dereferenceable(1) %0) #3
  ret void
}

; Function Attrs: noinline optnone uwtable mustprogress
define linkonce_odr dso_local void @_ZNSt8__detail16_Hashtable_allocISaINS_10_Hash_nodeISt4pairIKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEmELb1EEEEE19_M_deallocate_nodesEPSB_(%"struct.std::__detail::_Hashtable_alloc"* nonnull dereferenceable(1) %this, %"struct.std::__detail::_Hash_node"* %__n) #4 comdat align 2 {
entry:
  %this.addr = alloca %"struct.std::__detail::_Hashtable_alloc"*, align 8
...
while.cond:                                       ; preds = %while.body, %entry
  ...
  %tobool = icmp ne %"struct.std::__detail::_Hash_node"* %0, null
  br i1 %tobool, label %while.body, label %while.end

while.body:                                       ; preds = %while.cond
  %1 = load %"struct.std::__detail::_Hash_node"*, %"struct.std::__detail::_Hash_node"** %__n.addr, align 8
  store %"struct.std::__detail::_Hash_node"* %1, %"struct.std::__detail::_Hash_node"** %__tmp, align 8
  %2 = load %"struct.std::__detail::_Hash_node"*, %"struct.std::__detail::_Hash_node"** %__n.addr, align 8
  %call = call %"struct.std::__detail::_Hash_node"* @_ZNKSt8__detail10_Hash_nodeISt4pairIKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEmELb1EE7_M_nextEv(%"struct.std::__detail::_Hash_node"* nonnull dereferenceable(56) %2) #3
  store %"struct.std::__detail::_Hash_node"* %call, %"struct.std::__detail::_Hash_node"** %__n.addr, align 8
  %3 = load %"struct.std::__detail::_Hash_node"*, %"struct.std::__detail::_Hash_node"** %__tmp, align 8
  call void @_ZNSt8__detail16_Hashtable_allocISaINS_10_Hash_nodeISt4pairIKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEmELb1EEEEE18_M_deallocate_nodeEPSB_(%"struct.std::__detail::_Hashtable_alloc"* nonnull dereferenceable(1) %this1, %"struct.std::__detail::_Hash_node"* %3)
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local %"struct.std::__detail::_Hash_node"* @_ZNKSt8__detail10_Hash_nodeISt4pairIKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEmELb1EE7_M_nextEv(%"struct.std::__detail::_Hash_node"* nonnull dereferenceable(56) %this) #9 comdat align 2 {
entry:
...
entry:
  ...
  %call2 = call %"struct.std::pair.55"* @_ZNSt8__detail21_Hash_node_value_baseISt4pairIKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEmEE9_M_valptrEv(%"struct.std::__detail::_Hash_node_value_base"* nonnull dereferenceable(48) %1) #3
  call void @_ZNSt16allocator_traitsISaINSt8__detail10_Hash_nodeISt4pairIKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEmELb1EEEEE7destroyISA_EEvRSC_PT_(%"class.std::allocator.28"* nonnull align 1 dereferenceable(1) %call, %"struct.std::pair.55"* %call2) #3
  %2 = load %"struct.std::__detail::_Hash_node"*, %"struct.std::__detail::_Hash_node"** %__n.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local void @_ZNSt16allocator_traitsISaINSt8__detail10_Hash_nodeISt4pairIKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEmELb1EEEEE7destroyISA_EEvRSC_PT_(%"class.std::allocator.28"* nonnull align 1 dereferenceable(1) %__a, %"struct.std::pair.55"* %__p) #9 comdat align 2 {
entry:
  %__a.addr = alloca %"class.std::allocator.28"*, align 8
  %__p.addr = alloca %"struct.std::pair.55"*, align 8
  store %"class.std::allocator.28"* %__a, %"class.std::allocator.28"** %__a.addr, align 8
  store %"struct.std::pair.55"* %__p, %"struct.std::pair.55"** %__p.addr, align 8
  ...
  %2 = load %"struct.std::pair.55"*, %"struct.std::pair.55"** %__p.addr, align 8
  call void @_ZN9__gnu_cxx13new_allocatorINSt8__detail10_Hash_nodeISt4pairIKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEmELb1EEEE7destroyISB_EEvPT_(%"class.__gnu_cxx::new_allocator.29"* nonnull dereferenceable(1) %1, %"struct.std::pair.55"* %2) #3
  ret void
}
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local %"struct.std::pair.55"* @_ZNSt8__detail21_Hash_node_value_baseISt4pairIKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEmEE9_M_valptrEv(%"struct.std::__detail::_Hash_node_value_base"* nonnull dereferenceable(48) %this) #9 comdat align 2 {
entry:
  ...
  %call = call %"struct.std::pair.55"* @_ZN9__gnu_cxx16__aligned_bufferISt4pairIKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEmEE6_M_ptrEv(%"struct.__gnu_cxx::__aligned_buffer"* nonnull dereferenceable(40) %_M_storage) #3
  ret %"struct.std::pair.55"* %call
}
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local void @_ZN9__gnu_cxx13new_allocatorINSt8__detail10_Hash_nodeISt4pairIKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEmELb1EEEE7destroyISB_EEvPT_(%"class.__gnu_cxx::new_allocator.29"* nonnull dereferenceable(1) %this, %"struct.std::pair.55"* %__p) #9 comdat align 2 {
entry:
  %this.addr = alloca %"class.__gnu_cxx::new_allocator.29"*, align 8
  %__p.addr = alloca %"struct.std::pair.55"*, align 8
  store %"class.__gnu_cxx::new_allocator.29"* %this, %"class.__gnu_cxx::new_allocator.29"** %this.addr, align 8
  store %"struct.std::pair.55"* %__p, %"struct.std::pair.55"** %__p.addr, align 8
  %this1 = load %"class.__gnu_cxx::new_allocator.29"*, %"class.__gnu_cxx::new_allocator.29"** %this.addr, align 8
  %0 = load %"struct.std::pair.55"*, %"struct.std::pair.55"** %__p.addr, align 8
  call void @_ZNSt4pairIKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEmED2Ev(%"struct.std::pair.55"* nonnull dereferenceable(40) %0) #3
  ret void
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt4pairIKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEmED2Ev(%"struct.std::pair.55"* nonnull dereferenceable(40) %this) unnamed_addr #8 comdat align 2 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local %"struct.std::pair.55"* @_ZN9__gnu_cxx16__aligned_bufferISt4pairIKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEmEE6_M_ptrEv(%"struct.__gnu_cxx::__aligned_buffer"* nonnull dereferenceable(40) %this) #9 comdat align 2 {
entry:
  ...
  %0 = bitcast i8* %call to %"struct.std::pair.55"*
  ret %"struct.std::pair.55"* %0
}

; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local i8* @_ZN9__gnu_cxx16__aligned_bufferISt4pairIKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEmEE7_M_addrEv(%"struct.__gnu_cxx::__aligned_buffer"* nonnull dereferenceable(40) %this) #9 comdat align 2 {
entry:
  %this.addr = alloca %"struct.__gnu_cxx::__aligned_buffer"*, align 8
  store %"struct.__gnu_cxx::__aligned_buffer"* %this, %"struct.__gnu_cxx::__aligned_buffer"** %this.addr, align 8
  %this1 = load %"struct.__gnu_cxx::__aligned_buffer"*, %"struct.__gnu_cxx::__aligned_buffer"** %this.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local %"struct.std::__detail::_Hash_node"* @_ZNSt14pointer_traitsIPNSt8__detail10_Hash_nodeISt4pairIKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEmELb1EEEE10pointer_toERSB_(%"struct.std::__detail::_Hash_node"* nonnull align 8 dereferenceable(56) %__r) #9 comdat align 2 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local %"struct.std::__detail::_Hash_node"* @_ZSt9addressofINSt8__detail10_Hash_nodeISt4pairIKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEmELb1EEEEPT_RSC_(%"struct.std::__detail::_Hash_node"* nonnull align 8 dereferenceable(56) %__r) #9 comdat {
entry:
  %__r.addr = alloca %"struct.std::__detail::_Hash_node"*, align 8
  store %"struct.std::__detail::_Hash_node"* %__r, %"struct.std::__detail::_Hash_node"** %__r.addr, align 8
  %0 = load %"struct.std::__detail::_Hash_node"*, %"struct.std::__detail::_Hash_node"** %__r.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local %"struct.std::__detail::_Hash_node"* @_ZSt11__addressofINSt8__detail10_Hash_nodeISt4pairIKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEmELb1EEEEPT_RSC_(%"struct.std::__detail::_Hash_node"* nonnull align 8 dereferenceable(56) %__r) #9 comdat {
entry:
  %__r.addr = alloca %"struct.std::__detail::_Hash_node"*, align 8
  store %"struct.std::__detail::_Hash_node"* %__r, %"struct.std::__detail::_Hash_node"** %__r.addr, align 8
  %0 = load %"struct.std::__detail::_Hash_node"*, %"struct.std::__detail::_Hash_node"** %__r.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local void @_ZN9__gnu_cxx13new_allocatorINSt8__detail10_Hash_nodeISt4pairIKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEmELb1EEEE10deallocateEPSC_m(%"class.__gnu_cxx::new_allocator.29"* nonnull dereferenceable(1) %this, %"struct.std::__detail::_Hash_node"* %__p, i64 %0) #9 comdat align 2 {
entry:
  %this.addr = alloca %"class.__gnu_cxx::new_allocator.29"*, align 8
  %__p.addr = alloca %"struct.std::__detail::_Hash_node"*, align 8
  %.addr = alloca i64, align 8
...
entry:
  ...
  %call2 = call nonnull align 1 dereferenceable(1) %"class.std::allocator.28"* @_ZNSt8__detail16_Hashtable_allocISaINS_10_Hash_nodeISt4pairIKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEmELb1EEEEE17_M_node_allocatorEv(%"struct.std::__detail::_Hashtable_alloc"* nonnull dereferenceable(1) %this1)
  call void @_ZNSaIPNSt8__detail15_Hash_node_baseEEC2INS_10_Hash_nodeISt4pairIKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEmELb1EEEEERKSaIT_E(%"class.std::allocator.58"* nonnull dereferenceable(1) %__alloc, %"class.std::allocator.28"* nonnull align 1 dereferenceable(1) %call2) #3
  %1 = load %"struct.std::__detail::_Hash_node_base"**, %"struct.std::__detail::_Hash_node_base"*** %__ptr, align 8
  %2 = load i64, i64* %__n.addr, align 8
  invoke void @_ZNSt16allocator_traitsISaIPNSt8__detail15_Hash_node_baseEEE10deallocateERS3_PS2_m(%"class.std::allocator.58"* nonnull align 1 dereferenceable(1) %__alloc, %"struct.std::__detail::_Hash_node_base"** %1, i64 %2)
          to label %invoke.cont unwind label %lpad

invoke.cont:                                      ; preds = %entry
  call void @_ZNSaIPNSt8__detail15_Hash_node_baseEED2Ev(%"class.std::allocator.58"* nonnull dereferenceable(1) %__alloc) #3
  ret void
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local %"struct.std::__detail::_Hash_node_base"** @_ZNSt14pointer_traitsIPPNSt8__detail15_Hash_node_baseEE10pointer_toERS2_(%"struct.std::__detail::_Hash_node_base"** nonnull align 8 dereferenceable(8) %__r) #9 comdat align 2 {
entry:
...
entry:
  ...
  call void @_ZN9__gnu_cxx13new_allocatorIPNSt8__detail15_Hash_node_baseEEC2Ev(%"class.__gnu_cxx::new_allocator.59"* nonnull dereferenceable(1) %1) #3
  ret void
}

; Function Attrs: noinline optnone uwtable mustprogress
define linkonce_odr dso_local void @_ZNSt16allocator_traitsISaIPNSt8__detail15_Hash_node_baseEEE10deallocateERS3_PS2_m(%"class.std::allocator.58"* nonnull align 1 dereferenceable(1) %__a, %"struct.std::__detail::_Hash_node_base"** %__p, i64 %__n) #4 comdat align 2 {
entry:
  ...
  store i64 %__n, i64* %__n.addr, align 8
  %0 = load %"class.std::allocator.58"*, %"class.std::allocator.58"** %__a.addr, align 8
  ...
  %3 = load i64, i64* %__n.addr, align 8
  call void @_ZN9__gnu_cxx13new_allocatorIPNSt8__detail15_Hash_node_baseEE10deallocateEPS3_m(%"class.__gnu_cxx::new_allocator.59"* nonnull dereferenceable(1) %1, %"struct.std::__detail::_Hash_node_base"** %2, i64 %3)
  ret void
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSaIPNSt8__detail15_Hash_node_baseEED2Ev(%"class.std::allocator.58"* nonnull dereferenceable(1) %this) unnamed_addr #8 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::allocator.58"*, align 8
  store %"class.std::allocator.58"* %this, %"class.std::allocator.58"** %this.addr, align 8
  %this1 = load %"class.std::allocator.58"*, %"class.std::allocator.58"** %this.addr, align 8
  %0 = bitcast %"class.std::allocator.58"* %this1 to %"class.__gnu_cxx::new_allocator.59"*
  call void @_ZN9__gnu_cxx13new_allocatorIPNSt8__detail15_Hash_node_baseEED2Ev(%"class.__gnu_cxx::new_allocator.59"* nonnull dereferenceable(1) %0) #3
  ret void
}

; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local %"struct.std::__detail::_Hash_node_base"** @_ZSt9addressofIPNSt8__detail15_Hash_node_baseEEPT_RS3_(%"struct.std::__detail::_Hash_node_base"** nonnull align 8 dereferenceable(8) %__r) #9 comdat {
entry:
  %__r.addr = alloca %"struct.std::__detail::_Hash_node_base"**, align 8
  store %"struct.std::__detail::_Hash_node_base"** %__r, %"struct.std::__detail::_Hash_node_base"*** %__r.addr, align 8
  %0 = load %"struct.std::__detail::_Hash_node_base"**, %"struct.std::__detail::_Hash_node_base"*** %__r.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local %"struct.std::__detail::_Hash_node_base"** @_ZSt11__addressofIPNSt8__detail15_Hash_node_baseEEPT_RS3_(%"struct.std::__detail::_Hash_node_base"** nonnull align 8 dereferenceable(8) %__r) #9 comdat {
entry:
  %__r.addr = alloca %"struct.std::__detail::_Hash_node_base"**, align 8
  store %"struct.std::__detail::_Hash_node_base"** %__r, %"struct.std::__detail::_Hash_node_base"*** %__r.addr, align 8
  %0 = load %"struct.std::__detail::_Hash_node_base"**, %"struct.std::__detail::_Hash_node_base"*** %__r.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZN9__gnu_cxx13new_allocatorIPNSt8__detail15_Hash_node_baseEEC2Ev(%"class.__gnu_cxx::new_allocator.59"* nonnull dereferenceable(1) %this) unnamed_addr #8 comdat align 2 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local void @_ZN9__gnu_cxx13new_allocatorIPNSt8__detail15_Hash_node_baseEE10deallocateEPS3_m(%"class.__gnu_cxx::new_allocator.59"* nonnull dereferenceable(1) %this, %"struct.std::__detail::_Hash_node_base"** %__p, i64 %0) #9 comdat align 2 {
entry:
  %this.addr = alloca %"class.__gnu_cxx::new_allocator.59"*, align 8
  %__p.addr = alloca %"struct.std::__detail::_Hash_node_base"**, align 8
  %.addr = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZN9__gnu_cxx13new_allocatorIPNSt8__detail15_Hash_node_baseEED2Ev(%"class.__gnu_cxx::new_allocator.59"* nonnull dereferenceable(1) %this) unnamed_addr #8 comdat align 2 {
entry:
  %this.addr = alloca %"class.__gnu_cxx::new_allocator.59"*, align 8
  store %"class.__gnu_cxx::new_allocator.59"* %this, %"class.__gnu_cxx::new_allocator.59"** %this.addr, align 8
  %this1 = load %"class.__gnu_cxx::new_allocator.59"*, %"class.__gnu_cxx::new_allocator.59"** %this.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt8__detail21_Hashtable_ebo_helperILi0ESaINS_10_Hash_nodeISt4pairIKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEmELb1EEEELb1EED2Ev(%"struct.std::__detail::_Hashtable_ebo_helper.27"* nonnull dereferenceable(1) %this) unnamed_addr #8 comdat align 2 {
entry:
  %this.addr = alloca %"struct.std::__detail::_Hashtable_ebo_helper.27"*, align 8
  store %"struct.std::__detail::_Hashtable_ebo_helper.27"* %this, %"struct.std::__detail::_Hashtable_ebo_helper.27"** %this.addr, align 8
  %this1 = load %"struct.std::__detail::_Hashtable_ebo_helper.27"*, %"struct.std::__detail::_Hashtable_ebo_helper.27"** %this.addr, align 8
  %0 = bitcast %"struct.std::__detail::_Hashtable_ebo_helper.27"* %this1 to %"class.std::allocator.28"*
  call void @_ZNSaINSt8__detail10_Hash_nodeISt4pairIKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEmELb1EEEED2Ev(%"class.std::allocator.28"* nonnull dereferenceable(1) %0) #3
  ret void
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSaINSt8__detail10_Hash_nodeISt4pairIKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEmELb1EEEED2Ev(%"class.std::allocator.28"* nonnull dereferenceable(1) %this) unnamed_addr #8 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::allocator.28"*, align 8
  store %"class.std::allocator.28"* %this, %"class.std::allocator.28"** %this.addr, align 8
  %this1 = load %"class.std::allocator.28"*, %"class.std::allocator.28"** %this.addr, align 8
  %0 = bitcast %"class.std::allocator.28"* %this1 to %"class.__gnu_cxx::new_allocator.29"*
  call void @_ZN9__gnu_cxx13new_allocatorINSt8__detail10_Hash_nodeISt4pairIKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEmELb1EEEED2Ev(%"class.__gnu_cxx::new_allocator.29"* nonnull dereferenceable(1) %0) #3
  ret void
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZN9__gnu_cxx13new_allocatorINSt8__detail10_Hash_nodeISt4pairIKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEmELb1EEEED2Ev(%"class.__gnu_cxx::new_allocator.29"* nonnull dereferenceable(1) %this) unnamed_addr #8 comdat align 2 {
entry:
  %this.addr = alloca %"class.__gnu_cxx::new_allocator.29"*, align 8
  store %"class.__gnu_cxx::new_allocator.29"* %this, %"class.__gnu_cxx::new_allocator.29"** %this.addr, align 8
  %this1 = load %"class.__gnu_cxx::new_allocator.29"*, %"class.__gnu_cxx::new_allocator.29"** %this.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZN5rlbox15app_pointer_mapIjED2Ev(%"class.rlbox::app_pointer_map"* nonnull dereferenceable(112) %this) unnamed_addr #8 comdat align 2 {
entry:
  %this.addr = alloca %"class.rlbox::app_pointer_map"*, align 8
  store %"class.rlbox::app_pointer_map"* %this, %"class.rlbox::app_pointer_map"** %this.addr, align 8
  %this1 = load %"class.rlbox::app_pointer_map"*, %"class.rlbox::app_pointer_map"** %this.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt12_Vector_baseIPvSaIS0_EEC2Ev(%"struct.std::_Vector_base"* nonnull dereferenceable(24) %this) unnamed_addr #8 comdat align 2 {
entry:
  %this.addr = alloca %"struct.std::_Vector_base"*, align 8
  store %"struct.std::_Vector_base"* %this, %"struct.std::_Vector_base"** %this.addr, align 8
  %this1 = load %"struct.std::_Vector_base"*, %"struct.std::_Vector_base"** %this.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt12_Vector_baseIPvSaIS0_EE12_Vector_implC2Ev(%"struct.std::_Vector_base<void *, std::allocator<void *>>::_Vector_impl"* nonnull dereferenceable(24) %this) unnamed_addr #8 comdat align 2 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSaIPvEC2Ev(%"class.std::allocator.21"* nonnull dereferenceable(1) %this) unnamed_addr #8 comdat align 2 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt12_Vector_baseIPvSaIS0_EE17_Vector_impl_dataC2Ev(%"struct.std::_Vector_base<void *, std::allocator<void *>>::_Vector_impl_data"* nonnull dereferenceable(24) %this) unnamed_addr #8 comdat align 2 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZN9__gnu_cxx13new_allocatorIPvEC2Ev(%"class.__gnu_cxx::new_allocator.22"* nonnull dereferenceable(1) %this) unnamed_addr #8 comdat align 2 {
entry:
  %this.addr = alloca %"class.__gnu_cxx::new_allocator.22"*, align 8
  store %"class.__gnu_cxx::new_allocator.22"* %this, %"class.__gnu_cxx::new_allocator.22"** %this.addr, align 8
  %this1 = load %"class.__gnu_cxx::new_allocator.22"*, %"class.__gnu_cxx::new_allocator.22"** %this.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt12_Vector_baseIPvSaIS0_EED2Ev(%"struct.std::_Vector_base"* nonnull dereferenceable(24) %this) unnamed_addr #8 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
  %this.addr = alloca %"struct.std::_Vector_base"*, align 8
  %exn.slot = alloca i8*, align 8
  %ehselector.slot = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define linkonce_odr dso_local void @_ZNSt12_Destroy_auxILb1EE9__destroyIPPvEEvT_S4_(i8** %0, i8** %1) #9 comdat align 2 {
entry:
  %.addr = alloca i8**, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt12_Vector_baseIPvSaIS0_EE12_Vector_implD2Ev(%"struct.std::_Vector_base<void *, std::allocator<void *>>::_Vector_impl"* nonnull dereferenceable(24) %this) unnamed_addr #8 comdat align 2 {
entry:
  %this.addr = alloca %"struct.std::_Vector_base<void *, std::allocator<void *>>::_Vector_impl"*, align 8
  store %"struct.std::_Vector_base<void *, std::allocator<void *>>::_Vector_impl"* %this, %"struct.std::_Vector_base<void *, std::allocator<void *>>::_Vector_impl"** %this.addr, align 8
  %this1 = load %"struct.std::_Vector_base<void *, std::allocator<void *>>::_Vector_impl"*, %"struct.std::_Vector_base<void *, std::allocator<void *>>::_Vector_impl"** %this.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSaIPvED2Ev(%"class.std::allocator.21"* nonnull dereferenceable(1) %this) unnamed_addr #8 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::allocator.21"*, align 8
  store %"class.std::allocator.21"* %this, %"class.std::allocator.21"** %this.addr, align 8
  %this1 = load %"class.std::allocator.21"*, %"class.std::allocator.21"** %this.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZN9__gnu_cxx13new_allocatorIPvED2Ev(%"class.__gnu_cxx::new_allocator.22"* nonnull dereferenceable(1) %this) unnamed_addr #8 comdat align 2 {
entry:
  %this.addr = alloca %"class.__gnu_cxx::new_allocator.22"*, align 8
  store %"class.__gnu_cxx::new_allocator.22"* %this, %"class.__gnu_cxx::new_allocator.22"** %this.addr, align 8
  %this1 = load %"class.__gnu_cxx::new_allocator.22"*, %"class.__gnu_cxx::new_allocator.22"** %this.addr, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_Sbx_c_connector.cpp() #0 section ".text.startup" {
entry:
...
attributes #9 = { noinline nounwind optnone uwtable mustprogress "disable-tail-calls"="false" "frame-pointer"="all" "less-precise-fpmad"="false" "min-legal-vector-width"="0" "no-infs-fp-math"="false" "no-jump-tables"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" "unsafe-fp-math"="false" "use-soft-float"="false" }
...
attributes #15 = { nounwind readonly tainted "disable-tail-calls"="false" "frame-pointer"="all" "less-precise-fpmad"="false" "no-infs-fp-math"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" "unsafe-fp-math"="false" "use-soft-float"="false" }
attributes #16 = { nounwind tainted "disable-tail-calls"="false" "frame-pointer"="all" "less-precise-fpmad"="false" "no-infs-fp-math"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" "unsafe-fp-math"="false" "use-soft-float"="false" }
...
attributes #18 = { tainted "disable-tail-calls"="false" "frame-pointer"="all" "less-precise-fpmad"="false" "no-infs-fp-math"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" "unsafe-fp-math"="false" "use-soft-float"="false" }
attributes #19 = { noreturn nounwind "disable-tail-calls"="false" "frame-pointer"="all" "less-precise-fpmad"="false" "no-infs-fp-math"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" "unsafe-fp-math"="false" "use-soft-float"="false" }
